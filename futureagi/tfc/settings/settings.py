...
ERROR_FEED_OMEGA_LEASE_SECONDS = int(
    os.getenv("ERROR_FEED_OMEGA_LEASE_SECONDS", "120")
)
ERROR_FEED_OMEGA_PROJECT_CONCURRENCY = int(
    os.getenv("ERROR_FEED_OMEGA_PROJECT_CONCURRENCY", "2")
)
ERROR_FEED_OMEGA_RECONCILE_GRACE_SECONDS = int(
    os.getenv("ERROR_FEED_OMEGA_RECONCILE_GRACE_SECONDS", "60")
)
ERROR_FEED_OMEGA_RECONCILE_LOOKBACK_SECONDS = int(
    os.getenv("ERROR_FEED_OMEGA_RECONCILE_LOOKBACK_SECONDS", "86400")
)
ERROR_FEED_OMEGA_RECONCILE_PAGE_SIZE = int(
    os.getenv("ERROR_FEED_OMEGA_RECONCILE_PAGE_SIZE", "100")
)
ERROR_FEED_OMEGA_RECONCILE_PROJECT_LIMIT = int(
    os.getenv("ERROR_FEED_OMEGA_RECONCILE_PROJECT_LIMIT", "100")
)
ERROR_FEED_OMEGA_RECONCILE_MAX_PAGES_PER_PROJECT = int(
    os.getenv("ERROR_FEED_OMEGA_RECONCILE_MAX_PAGES_PER_PROJECT", "10")
)
