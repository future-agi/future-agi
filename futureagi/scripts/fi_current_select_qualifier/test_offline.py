#!/usr/bin/env python3
"""Offline contract tests for the current CATALOG SELECT-only qualifier."""
...
class SafetyTests(unittest.TestCase):
    def test_schema_is_current(self):
        self.assertEqual(safety.SCHEMA, "fi-current-select-only/v2")
...
class QualificationContractTests(unittest.TestCase):
    ...
    def test_qualified_subset_and_openapi_inventory_are_exact(self):
        ...
        matrix = (
            PACKAGE_DIR.parents[2] / "docs/FI_INTERACTIVE_READ_MATRIX.md"
