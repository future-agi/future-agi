#!/usr/bin/env python3
"""Machine-check the TH-7247 OpenAPI impact inventory.
...
def expected_operations() -> frozenset[tuple[str, str]]:
    ...
    if len(operations) != len(set(operations)):
        raise AssertionError("TH-7247 OpenAPI inventory contains a duplicate operation")
...
def verify_repo_inventory(repo_root: Path) -> dict[str, Any]:
    ...
    if errors:
        raise AssertionError("TH-7247 OpenAPI inventory drifted: " + " | ".join(errors))
    return inventory
