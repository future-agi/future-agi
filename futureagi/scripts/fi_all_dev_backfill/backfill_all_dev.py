...
the six tables in an already-provisioned ``fi_catalog_dev_*`` database.
"""
...
ACKNOWLEDGEMENT = "FI_BACKFILL_ALL_WORKSPACE_BOUND_DEV_DATA"
CATALOG_DATABASE_RE = re.compile(r"^fi_catalog_dev_[a-z0-9_]+$")
EXPECTED_TABLES = {
...
def _arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--producer-name-prefix", default="fi-all-dev-producer")
