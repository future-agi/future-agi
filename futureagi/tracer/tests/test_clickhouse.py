...
class TestClickHouseSchema:
    ...
    def test_dataset_dict_keeps_soft_deleted_dataset_names(self):
        """Dataset dashboards need names for historical cells on soft-deleted datasets."""
        ...
        assert "AND deleted = 0" not in DATASET_DICT
