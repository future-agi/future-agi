...
class ExperimentTableRowsColumnConfigSerializer(serializers.Serializer):
    ...
    min_score = serializers.JSONField(required=False, allow_null=True)
    max_score = serializers.JSONField(required=False, allow_null=True)
    median_score = serializers.JSONField(required=False, allow_null=True)
