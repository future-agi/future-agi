...
if [[ ! -f "$ENV_FILE" || "${ans:-}" == "y" || "${ans:-}" == "Y" || "${ans:-}" == "yes" ]]; then
  ...
  CODE_EXECUTOR_INTERNAL_API_KEY=$(openssl rand -hex 32)
  PG_PASSWORD=$(openssl rand -hex 24)
  MINIO_ROOT_PASSWORD=$(openssl rand -hex 24)
  RABBITMQ_PASSWORD=$(openssl rand -hex 24)
  ok "Generated SECRET_KEY, AGENTCC_INTERNAL_API_KEY, AGENTCC_ADMIN_TOKEN, CODE_EXECUTOR_INTERNAL_API_KEY, PG_PASSWORD, MINIO_ROOT_PASSWORD, RABBITMQ_PASSWORD"
...
CODE_EXECUTOR_INTERNAL_API_KEY=${CODE_EXECUTOR_INTERNAL_API_KEY}
