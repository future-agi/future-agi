...
SCHEMA: Any = None
SMOKE_SCHEMA = "th7247-kartik-dev-analogue-functional-smoke/0816h/v1"
EXPECTED_RUNTIME_WRAPPER_PATH = "/run/th7247-kartik-smoke-0816h/kartik-smoke-0816h.py"
REGISTRY_HANDOFF_PATH = "/run/th7247-kartik-smoke-0816h/registry-profile-handoff.json"
ATTRIBUTE_CURSOR_CACHE_TMPFS = Path("/tmp")
ATTRIBUTE_CURSOR_CACHE_PREFIX = "th7247-kartik-smoke-0816h-cursor-"
...
FROZEN_LOCAL_IMAGE_TAG = "th7247-current-select:0816k-df6e48b0"
...
FROZEN_CATALOG_DATABASE = "th7247_catalog_dev_kartik_0816h"
...
FORBIDDEN_ENV_KEYS = (
    ...
    "TH7247_KARTIK_ACTIVATED_DENSE_VOICE_PROJECT_ID",
    "TH7247_KARTIK_ACTIVATED_SPARSE_TRACE_PROJECT_ID",
    "TH7247_KARTIK_END_UTC",
    "TH7247_KARTIK_NONACTIVATED_DENSE_TRACE_PROJECT_ID",
)
...
def _install_attribute_cursor_cache(phase: str) -> dict[str, Any]:
    ...
    sentinel = {"schema": "th7247-attribute-cursor-cache/0816h/v1"}
...
def _handoff_public(context: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema": "th7247-kartik-registry-handoff/0816h/v1",
        "registry_ok": True,
...
def _handoff_key(aad: bytes) -> bytes:
    ...
    return hmac.new(
        secret,
        b"th7247-kartik-smoke-0816h-registry-handoff\0" + hashlib.sha256(aad).digest(),
        hashlib.sha256,
    ).digest()
