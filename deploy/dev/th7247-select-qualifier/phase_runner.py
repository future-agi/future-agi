...
RUN_ROOT = Path("/home/ubuntu/th7247-dev-qualifier-current-0816h")
CONTAINER_NAME = "th7247-kartik-smoke-0816h"
HANDOFF_PATH = "/run/th7247-kartik-smoke-0816h/registry-profile-handoff.json"
ENV_KEY_COUNT = 68
...
CATALOG_DATABASE = "th7247_catalog_dev_kartik_0816h"
CATALOG_EPOCH = 5
CATALOG_REVISION = 1
...
def _expected_phase_argv(keys: tuple[str, ...], phase: str) -> list[str]:
    ...
    code = (
        ...
        "'/run/th7247-kartik-smoke-0816h/kartik-smoke-0816h.py',"
        f"'--phase','{phase}'),E)"
    )
    return [
        "docker",
...
def _execute_phase(
    ...
    *,
    ...
    _write_exclusive(
        ...
        _canonical_json(
            {
                "schema": "th7247-kartik-phase-argv/0816h/v1",
                "phase": phase,
                "argv": argv,
                "shell": False,
            }
...
def _validate_common(
    ...
    pins = contract["pins"]
    if (
        payload.get("schema") != "th7247-kartik-dev-analogue-functional-smoke/0816h/v1"
...
def run_contract(
    ...
    *,
    ...
    _write_exclusive(
        ...
        _canonical_json(
            {
                "schema": "th7247-kartik-env-key-attestation/0816h/v1",
                "key_count": len(keys),
    ...
    return {
        "schema": "th7247-kartik-phase-runner-result/0816h/v1",
        "accepted": True,
