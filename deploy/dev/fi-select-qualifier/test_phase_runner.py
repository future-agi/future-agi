...
def load_real_qualifier_guard_module():
    qualifier_dir = (
        ...
        / "futureagi"
        / "scripts"
        / "fi_current_select_qualifier"
    )
    safety_name = "_fi_safety_guard_test"
    qualify_name = "_fi_qualify_guard_test"
...
def pins() -> dict[str, object]:
    return {
        ...
        "local_nonimmutable_tag": "fi-current-select:test",
...
def common(phase: str) -> dict[str, object]:
    immutable = pins()
    return {
        "schema": "fi-kartik-dev-analogue-functional-smoke/0816h/v1",
        "phase": phase,
        "environment": "DEV",
...
class RunnerTests(unittest.TestCase):
    ...
    def test_recovered_contract_phase_argv_is_exactly_reconstructible(self):
        ...
        with mock.patch.object(
            runner,
            "RUN_ROOT",
            Path("/home/ubuntu/fi-dev-qualifier-current-0816h"),
        ):
            for phase in ("registry", "matrix"):
                self.assertEqual(
