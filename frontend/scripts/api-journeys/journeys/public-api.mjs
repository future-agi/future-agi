...
export const publicApiJourneys = [
  ...
  {
    id: "PUBLIC-AUTH-013",
    title: "Integration and OTLP health routes expose safe boundaries",
    tags: ["public", "auth", "guard", "integrations", "otlp", "health"],
    public: true,
    async run({ apiBase, evidence }) {
      const zeroUuid = "00000000-0000-4000-8000-000000000456";
      ...
      const authGuardEndpointSpecs = [["GET", "/integrations/sync-logs/{id}/"]];
