...
const QUICK_STARTS = {
  ...
  prompt: {
    buttonText: "Prove a prompt edit is better",
    expectedTitleText: "Prove a prompt edit is better",
    expectedStepText: "Write the prompt you want to improve",
  ...
  agent: {
    buttonText: "Watch your agent handle a hard call",
    expectedTitleText: "Watch your agent handle a hard call",
    expectedStepText: "Stand up an agent you can run",
  ...
  gateway: {
    buttonText: "Route LLM traffic safely",
    expectedTitleText: "Route LLM traffic safely",
    expectedStepText: "Route your first request",
  ...
  evals: {
    buttonText: "Catch failing responses before users do",
    expectedTitleText: "Catch failing responses before users do",
    expectedStepText: "Pick what to test",
  ...
  voice: {
    buttonText: "Test a voice agent",
    expectedTitleText: "Test a voice agent",
    expectedStepText: "Bring in a voice agent to test",
