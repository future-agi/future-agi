...
import {
  Box, Typography, Button, Menu, MenuItem, ListItemIcon, ListItemText, Divider, Checkbox,
} from "@mui/material";

import Iconify from "src/components/iconify";
import MockBadge from "../../../../components/MockBadge";
import {
  TRACE_COLUMNS, defaultTraceColumns, GROUPINGS, neutralCheckboxSx,
...
// Group-by axis picker. Failure views carry a Sample badge (they have no real
// failure-taxonomy field and are derived from the run's eval failures).
      ...
      <Menu anchorEl={anchor} open={!!anchor} onClose={() => setAnchor(null)}>
        {GROUPINGS.map((g) => (
          ...
          >
            ...
            <Typography sx={{ typography: "s2", flex: 1 }}>{g.label}</Typography>
            {g.sample && <MockBadge />}
          </MenuItem>
        ))}
      </Menu>
