...
export default function RunsPanel({ env, envState, runs, onStart, onOpenRun, onGo }) {
  ...
  // P26: on a backed environment the caller hands us the overlaid state, so
  ...
  // template/forked env has no backend detail and keeps the store's own list;
  // either way this reads one list, so the two lines cannot disagree.
