...
import { ACTOR_LIBRARY, castFor as actorCastFor } from "src/api/simulate-environments/_fixtures/actors";
...
const BRANCHES = [
  ...
  { id: "people", label: "Personas & actors", color: BUILD_TONES.accent, icon: "solar:users-group-rounded-linear" },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button size="small" onClick={() => onGo?.("contract")} sx={{ typography: "s2", fontWeight: "fontWeightBold", color: "primary.main", flexShrink: 0 }}>
          Contract
        </Button>
      </Stack>
    </SectionCard>
