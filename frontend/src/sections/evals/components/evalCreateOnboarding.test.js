...
describe("evalCreateOnboarding", () => {
  ...
  it("keeps setup quick-start attribution across eval review and repair routes", () => {
    ...
    expect(
      ...
      "/dashboard/home?source=onboarding&target_event=first_quality_loop_completed&run_id=run-2&source_type=dataset&source_id=data-1&rerun_from=source_fix&previous_run_id=run-1&quick_start_goal=evaluate_quality&quick_start_id=evals&quick_start_primary_path=evals",
    );
  });
