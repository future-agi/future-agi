                        ...
                        >
                          ...
                          <Box sx={{ flex: 1, overflow: "auto", px: 2 }}>
                            {barData.rows.map((row, i) => {
                              ...
                              const color = getSeriesColor(seriesColorMap, row.name || row.label);
                              const pct =
                                      ...
                                      >
                                        <Box
                                          ...
                                          sx={{
                                            ...
                                            height: 8,
                                            borderRadius: "2px",
                                            bgcolor: getSeriesColor(seriesColorMap, s.name),
              ...
              {isPie || isTable || isMetricCard ? (
                ...
                <>
                  ...
                  <Box>
                    ...
                    {previewSeries.map((s, si) => {
                      const seriesColor = getSeriesColor(seriesColorMap, s.name);
                      return (
                      <Stack
                        key={si}
                        direction="row"
