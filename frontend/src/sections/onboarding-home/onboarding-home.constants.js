...
export const ONBOARDING_GOAL_OPTIONS = [
  ...
  },
  {
    ...
    primaryPath: "prompt",
    label: "Prove a prompt edit is better",
    description:
  ...
  },
  {
    ...
    primaryPath: "agent",
    label: "Watch your agent handle a hard call",
    description:
  ...
  },
  {
    ...
    primaryPath: "evals",
    label: "Catch failing responses before users do",
    description:
...
export const ONBOARDING_STAGE_COPY = {
  ...
  activated: {
    eyebrow: "First quality loop complete",
