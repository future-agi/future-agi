const SCHEMA_VERSION = "activation-state-2026-06-08.v2";
...
const availableGoals = [
  ...
  },
  {
    ...
    outcome_preview: "A tested prompt version with a comparison baseline.",
    estimated_minutes: 6,
    disabled: false,
    disabled_reason: null,
  },
  {
    ...
    outcome_preview: "A scenario run you can inspect and turn into coverage.",
    estimated_minutes: 8,
    disabled: false,
    disabled_reason: null,
  },
  {
    ...
    outcome_preview:
      "A gateway request log ready for routing or policy review.",
    estimated_minutes: 7,
    disabled: false,
    disabled_reason: null,
  },
  {
    ...
    outcome_preview: "An eval run with results and failures ready to review.",
    estimated_minutes: 7,
    disabled: false,
    disabled_reason: null,
  },
  {
    ...
    outcome_preview: "A test call transcript with success criteria to add.",
    estimated_minutes: 8,
    disabled: false,
    disabled_reason: null,
  },
  {
    ...
    outcome_preview: "A sample trace reviewed before connecting real data.",
    estimated_minutes: 2,
    disabled: false,
    disabled_reason: null,
  },
...
export const activationStateFixtures = {
  ...
  observeFirstLoopComplete: baseState({
    ...
    last_meaningful_event: {
      ...
      is_sample: false,
      // activation_event_path is the backend event's product path (the quality
      // loop is completed in evals), distinct from primary_path ("observe").
      // See internal-docs analytics-measurement contract (doc 70).
      path: "evals",
      metadata: {},
    },
  }),
  ...
  promptActivated: baseState({
    ...
    recommended_action: promptAction({
      ...
      description: "Review prompt metrics and continue improving.",
      href: "/dashboard/workbench/create/prompt-1?source=onboarding&onboarding=metrics&tab=Metrics",
