...
export const ENVIRONMENT_TEMPLATES = [
  /* ─────────────────────── Voice & chat ─────────────────────── */
  {
    ...
    tools: [
      ...
      { name: "check_return_eligibility", desc: "Confirm a return fits the policy" },
      { name: "generate_return_label", desc: "Email a printable return label" },
      { name: "cancel_order", desc: "Cancel while still in warehouse" },
      { name: "update_shipping_address", desc: "Change delivery before dispatch" },
    ],
    rules: [
      ...
      "Never promise a delivery date sooner than the carrier's ETA",
