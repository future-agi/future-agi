...
describe("PostHog key guard", () => {
  ...
  it("exposes unavailable feature flags as undefined before initialization", () => {
    expect(isPostHogAvailable()).toBe(false);
    expect(getFeatureFlagValue("onboarding_first_run_home")).toBeUndefined();
  });
});
