...
export const modelHubAnnotationQueuesListResponseResultsItemAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesListResponseResultsItemAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesListResponseResultsItemReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesListResponseResultsItemReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesListResponseResultsItemLabelsItemOrderMin =
  -2147483648;
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(modelHubAnnotationQueuesListResponseResultsItemNameMax),
      description: zod.string().optional(),
      instructions: zod.string().optional(),
      status: zod.enum(["draft", "active", "paused", "completed"]).optional(),
      assignment_strategy: zod
        .enum(["manual", "round_robin", "load_balanced"])
        .optional(),
      annotations_required: zod
        .number()
        .min(
          modelHubAnnotationQueuesListResponseResultsItemAnnotationsRequiredMin,
        )
        .max(
          modelHubAnnotationQueuesListResponseResultsItemAnnotationsRequiredMax,
        )
        .optional(),
      reservation_timeout_minutes: zod
        .number()
        .min(
          modelHubAnnotationQueuesListResponseResultsItemReservationTimeoutMinutesMin,
        )
        .max(
          modelHubAnnotationQueuesListResponseResultsItemReservationTimeoutMinutesMax,
        )
        .optional(),
        ...
        .array(
          zod.object({
            ...
            order: zod
              .number()
              .min(
                modelHubAnnotationQueuesListResponseResultsItemLabelsItemOrderMin,
              )
              .max(
                modelHubAnnotationQueuesListResponseResultsItemLabelsItemOrderMax,
              )
              .optional(),
          }),
        )
        ...
        .array(
          zod.object({
            ...
            role: zod
              ...
              .min(1)
              .default(
                modelHubAnnotationQueuesListResponseResultsItemAnnotatorsItemRoleDefault,
              ),
      ...
      label_ids: zod
        ...
        .default(
          modelHubAnnotationQueuesListResponseResultsItemLabelIdsDefault,
        ),
      annotator_ids: zod
        .array(zod.string().uuid())
        .default(
          modelHubAnnotationQueuesListResponseResultsItemAnnotatorIdsDefault,
        ),
      annotator_roles: zod
        .record(zod.string(), zod.object({}).passthrough())
        .default(
          modelHubAnnotationQueuesListResponseResultsItemAnnotatorRolesDefault,
        ),
...
export const modelHubAnnotationQueuesCreateBodyAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesCreateBodyAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesCreateBodyReservationTimeoutMinutesMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesCreateBody = zod.object({
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesCreateBodyAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesCreateBodyAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(modelHubAnnotationQueuesCreateBodyReservationTimeoutMinutesMin)
    .max(modelHubAnnotationQueuesCreateBodyReservationTimeoutMinutesMax)
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
    .boolean()
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesCreateBodyLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesCreateBodyAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(modelHubAnnotationQueuesCreateBodyAnnotatorRolesDefault),
});
...
export const modelHubAnnotationQueuesForSourceResponseResultsItemNameMax = 255;

export const modelHubAnnotationQueuesForSourceResponseResultsItemAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesForSourceResponseResultsItemAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesForSourceResponseResultsItemReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesForSourceResponseResultsItemReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesForSourceResponseResultsItemLabelsItemOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesForSourceResponseResultsItemLabelsItemOrderMax = 2147483647;

export const modelHubAnnotationQueuesForSourceResponseResultsItemAnnotatorsItemRoleDefault = `annotator`;

export const modelHubAnnotationQueuesForSourceResponseResultsItemLabelIdsDefault =
  [];
export const modelHubAnnotationQueuesForSourceResponseResultsItemAnnotatorIdsDefault =
  [];
export const modelHubAnnotationQueuesForSourceResponseResultsItemAnnotatorRolesDefault =
  {};
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(modelHubAnnotationQueuesForSourceResponseResultsItemNameMax),
      description: zod.string().optional(),
      instructions: zod.string().optional(),
      status: zod.enum(["draft", "active", "paused", "completed"]).optional(),
      assignment_strategy: zod
      ...
      annotations_required: zod
        .number()
        .min(
          modelHubAnnotationQueuesForSourceResponseResultsItemAnnotationsRequiredMin,
        )
        .max(
          modelHubAnnotationQueuesForSourceResponseResultsItemAnnotationsRequiredMax,
        )
        .optional(),
      reservation_timeout_minutes: zod
        .number()
        .min(
          modelHubAnnotationQueuesForSourceResponseResultsItemReservationTimeoutMinutesMin,
        )
        .max(
          modelHubAnnotationQueuesForSourceResponseResultsItemReservationTimeoutMinutesMax,
        )
        .optional(),
      requires_review: zod.boolean().optional(),
      auto_assign: zod
        ...
        .array(
          zod.object({
            ...
            order: zod
              .number()
              .min(
                modelHubAnnotationQueuesForSourceResponseResultsItemLabelsItemOrderMin,
              )
              .max(
                modelHubAnnotationQueuesForSourceResponseResultsItemLabelsItemOrderMax,
              )
              .optional(),
          }),
        )
        ...
        .array(
          zod.object({
            ...
            role: zod
              ...
              .min(1)
              .default(
                modelHubAnnotationQueuesForSourceResponseResultsItemAnnotatorsItemRoleDefault,
              ),
            roles: zod.string().optional(),
          }),
        )
      ...
      label_ids: zod
        .array(zod.string().uuid())
        .default(
          modelHubAnnotationQueuesForSourceResponseResultsItemLabelIdsDefault,
        ),
      annotator_ids: zod
        .array(zod.string().uuid())
        .default(
          modelHubAnnotationQueuesForSourceResponseResultsItemAnnotatorIdsDefault,
        ),
      annotator_roles: zod
        .record(zod.string(), zod.object({}).passthrough())
        .default(
          modelHubAnnotationQueuesForSourceResponseResultsItemAnnotatorRolesDefault,
        ),
      label_count: zod.number().optional(),
      annotator_count: zod.number().optional(),
      item_count: zod.number().optional(),
...
export const ModelHubAnnotationQueuesReadParams = zod.object({
  id: zod
    .string()
    .uuid()
    .describe("A UUID string identifying this annotation queue."),
});

export const modelHubAnnotationQueuesReadResponseNameMax = 255;

export const modelHubAnnotationQueuesReadResponseAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesReadResponseAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesReadResponseReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesReadResponseReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesReadResponseLabelsItemOrderMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesReadResponse = zod.object({
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesReadResponseAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesReadResponseAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(modelHubAnnotationQueuesReadResponseReservationTimeoutMinutesMin)
    .max(modelHubAnnotationQueuesReadResponseReservationTimeoutMinutesMax)
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
    .boolean()
  ...
  labels: zod
    .array(
      zod.object({
        ...
        order: zod
          .number()
          .min(modelHubAnnotationQueuesReadResponseLabelsItemOrderMin)
          .max(modelHubAnnotationQueuesReadResponseLabelsItemOrderMax)
          .optional(),
      }),
    )
    .optional(),
    ...
    .array(
      zod.object({
        ...
        role: zod
          ...
          .min(1)
          .default(
            modelHubAnnotationQueuesReadResponseAnnotatorsItemRoleDefault,
          ),
        roles: zod.string().optional(),
      }),
    )
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesReadResponseLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesReadResponseAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(modelHubAnnotationQueuesReadResponseAnnotatorRolesDefault),
  label_count: zod.number().optional(),
  annotator_count: zod.number().optional(),
  item_count: zod.number().optional(),
  completed_count: zod.number().optional(),
...
export const modelHubAnnotationQueuesUpdateBodyAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesUpdateBodyAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesUpdateBodyReservationTimeoutMinutesMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesUpdateBody = zod.object({
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesUpdateBodyAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesUpdateBodyAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(modelHubAnnotationQueuesUpdateBodyReservationTimeoutMinutesMin)
    .max(modelHubAnnotationQueuesUpdateBodyReservationTimeoutMinutesMax)
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
    .boolean()
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesUpdateBodyLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesUpdateBodyAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(modelHubAnnotationQueuesUpdateBodyAnnotatorRolesDefault),
});

export const modelHubAnnotationQueuesUpdateResponseNameMax = 255;

export const modelHubAnnotationQueuesUpdateResponseAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesUpdateResponseAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesUpdateResponseReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesUpdateResponseReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesUpdateResponseLabelsItemOrderMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesUpdateResponse = zod.object({
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesUpdateResponseAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesUpdateResponseAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(modelHubAnnotationQueuesUpdateResponseReservationTimeoutMinutesMin)
    .max(modelHubAnnotationQueuesUpdateResponseReservationTimeoutMinutesMax)
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
    .boolean()
  ...
  labels: zod
    .array(
      zod.object({
        ...
        order: zod
          .number()
          .min(modelHubAnnotationQueuesUpdateResponseLabelsItemOrderMin)
          .max(modelHubAnnotationQueuesUpdateResponseLabelsItemOrderMax)
          .optional(),
      }),
    )
    .optional(),
    ...
    .array(
      zod.object({
        ...
        role: zod
          ...
          .min(1)
          .default(
            modelHubAnnotationQueuesUpdateResponseAnnotatorsItemRoleDefault,
          ),
        roles: zod.string().optional(),
      }),
    )
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesUpdateResponseLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesUpdateResponseAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(modelHubAnnotationQueuesUpdateResponseAnnotatorRolesDefault),
  label_count: zod.number().optional(),
  annotator_count: zod.number().optional(),
  item_count: zod.number().optional(),
  completed_count: zod.number().optional(),
...
export const modelHubAnnotationQueuesPartialUpdateBodyAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesPartialUpdateBodyAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesPartialUpdateBodyReservationTimeoutMinutesMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesPartialUpdateBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesPartialUpdateBodyNameMax),
  description: zod.string().optional(),
  instructions: zod.string().optional(),
  assignment_strategy: zod
    .enum(["manual", "round_robin", "load_balanced"])
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesPartialUpdateBodyAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesPartialUpdateBodyAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(modelHubAnnotationQueuesPartialUpdateBodyReservationTimeoutMinutesMin)
    .max(modelHubAnnotationQueuesPartialUpdateBodyReservationTimeoutMinutesMax)
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
    .boolean()
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesPartialUpdateBodyLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesPartialUpdateBodyAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(modelHubAnnotationQueuesPartialUpdateBodyAnnotatorRolesDefault),
});

export const modelHubAnnotationQueuesPartialUpdateResponseNameMax = 255;

export const modelHubAnnotationQueuesPartialUpdateResponseAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesPartialUpdateResponseAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesPartialUpdateResponseReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesPartialUpdateResponseReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesPartialUpdateResponseLabelsItemOrderMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesPartialUpdateResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesPartialUpdateResponseNameMax),
  description: zod.string().optional(),
  instructions: zod.string().optional(),
  status: zod.enum(["draft", "active", "paused", "completed"]).optional(),
  assignment_strategy: zod
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesPartialUpdateResponseAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesPartialUpdateResponseAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(
      modelHubAnnotationQueuesPartialUpdateResponseReservationTimeoutMinutesMin,
    )
    .max(
      modelHubAnnotationQueuesPartialUpdateResponseReservationTimeoutMinutesMax,
    )
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
  ...
  labels: zod
    .array(
      zod.object({
        ...
        order: zod
          .number()
          .min(modelHubAnnotationQueuesPartialUpdateResponseLabelsItemOrderMin)
          .max(modelHubAnnotationQueuesPartialUpdateResponseLabelsItemOrderMax)
          .optional(),
      }),
    )
    .optional(),
    ...
    .array(
      zod.object({
        ...
        role: zod
          ...
          .min(1)
          .default(
            modelHubAnnotationQueuesPartialUpdateResponseAnnotatorsItemRoleDefault,
          ),
        roles: zod.string().optional(),
      }),
    )
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesPartialUpdateResponseLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesPartialUpdateResponseAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(
      modelHubAnnotationQueuesPartialUpdateResponseAnnotatorRolesDefault,
    ),
  label_count: zod.number().optional(),
  annotator_count: zod.number().optional(),
  item_count: zod.number().optional(),
...
export const ModelHubAnnotationQueuesAddLabelBody = zod.object({
  ...
  required: zod
    .boolean()
    .default(modelHubAnnotationQueuesAddLabelBodyRequiredDefault),
});
...
export const modelHubAnnotationQueuesAgreementResponseNameMax = 255;

export const modelHubAnnotationQueuesAgreementResponseAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesAgreementResponseAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesAgreementResponseReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesAgreementResponseReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesAgreementResponseLabelsItemOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesAgreementResponseLabelsItemOrderMax = 2147483647;

export const modelHubAnnotationQueuesAgreementResponseAnnotatorsItemRoleDefault = `annotator`;

export const modelHubAnnotationQueuesAgreementResponseLabelIdsDefault = [];
export const modelHubAnnotationQueuesAgreementResponseAnnotatorIdsDefault = [];
export const modelHubAnnotationQueuesAgreementResponseAnnotatorRolesDefault =
  {};
...
export const ModelHubAnnotationQueuesAgreementResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesAgreementResponseNameMax),
  description: zod.string().optional(),
  instructions: zod.string().optional(),
  status: zod.enum(["draft", "active", "paused", "completed"]).optional(),
  assignment_strategy: zod
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesAgreementResponseAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesAgreementResponseAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(modelHubAnnotationQueuesAgreementResponseReservationTimeoutMinutesMin)
    .max(modelHubAnnotationQueuesAgreementResponseReservationTimeoutMinutesMax)
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
    .boolean()
  ...
  labels: zod
    .array(
      zod.object({
        ...
        order: zod
          .number()
          .min(modelHubAnnotationQueuesAgreementResponseLabelsItemOrderMin)
          .max(modelHubAnnotationQueuesAgreementResponseLabelsItemOrderMax)
          .optional(),
      }),
    )
    .optional(),
    ...
    .array(
      zod.object({
        ...
        role: zod
          ...
          .min(1)
          .default(
            modelHubAnnotationQueuesAgreementResponseAnnotatorsItemRoleDefault,
          ),
        roles: zod.string().optional(),
      }),
    )
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesAgreementResponseLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesAgreementResponseAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(modelHubAnnotationQueuesAgreementResponseAnnotatorRolesDefault),
  label_count: zod.number().optional(),
  annotator_count: zod.number().optional(),
  item_count: zod.number().optional(),
  completed_count: zod.number().optional(),
...
export const modelHubAnnotationQueuesAnalyticsResponseNameMax = 255;

export const modelHubAnnotationQueuesAnalyticsResponseAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesAnalyticsResponseAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesAnalyticsResponseReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesAnalyticsResponseReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesAnalyticsResponseLabelsItemOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesAnalyticsResponseLabelsItemOrderMax = 2147483647;

export const modelHubAnnotationQueuesAnalyticsResponseAnnotatorsItemRoleDefault = `annotator`;

export const modelHubAnnotationQueuesAnalyticsResponseLabelIdsDefault = [];
export const modelHubAnnotationQueuesAnalyticsResponseAnnotatorIdsDefault = [];
export const modelHubAnnotationQueuesAnalyticsResponseAnnotatorRolesDefault =
  {};
...
export const ModelHubAnnotationQueuesAnalyticsResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesAnalyticsResponseNameMax),
  description: zod.string().optional(),
  instructions: zod.string().optional(),
  status: zod.enum(["draft", "active", "paused", "completed"]).optional(),
  assignment_strategy: zod
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesAnalyticsResponseAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesAnalyticsResponseAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(modelHubAnnotationQueuesAnalyticsResponseReservationTimeoutMinutesMin)
    .max(modelHubAnnotationQueuesAnalyticsResponseReservationTimeoutMinutesMax)
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
    .boolean()
  ...
  labels: zod
    .array(
      zod.object({
        ...
        order: zod
          .number()
          .min(modelHubAnnotationQueuesAnalyticsResponseLabelsItemOrderMin)
          .max(modelHubAnnotationQueuesAnalyticsResponseLabelsItemOrderMax)
          .optional(),
      }),
    )
    .optional(),
    ...
    .array(
      zod.object({
        ...
        role: zod
          ...
          .min(1)
          .default(
            modelHubAnnotationQueuesAnalyticsResponseAnnotatorsItemRoleDefault,
          ),
        roles: zod.string().optional(),
      }),
    )
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesAnalyticsResponseLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesAnalyticsResponseAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(modelHubAnnotationQueuesAnalyticsResponseAnnotatorRolesDefault),
  label_count: zod.number().optional(),
  annotator_count: zod.number().optional(),
  item_count: zod.number().optional(),
  completed_count: zod.number().optional(),
...
export const modelHubAnnotationQueuesExportFieldsResponseNameMax = 255;

export const modelHubAnnotationQueuesExportFieldsResponseAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesExportFieldsResponseAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesExportFieldsResponseReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesExportFieldsResponseReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesExportFieldsResponseLabelsItemOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesExportFieldsResponseLabelsItemOrderMax = 2147483647;

export const modelHubAnnotationQueuesExportFieldsResponseAnnotatorsItemRoleDefault = `annotator`;

export const modelHubAnnotationQueuesExportFieldsResponseLabelIdsDefault = [];
export const modelHubAnnotationQueuesExportFieldsResponseAnnotatorIdsDefault =
  [];
export const modelHubAnnotationQueuesExportFieldsResponseAnnotatorRolesDefault =
  {};
...
export const ModelHubAnnotationQueuesExportFieldsResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesExportFieldsResponseNameMax),
  description: zod.string().optional(),
  instructions: zod.string().optional(),
  status: zod.enum(["draft", "active", "paused", "completed"]).optional(),
  assignment_strategy: zod
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesExportFieldsResponseAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesExportFieldsResponseAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(
      modelHubAnnotationQueuesExportFieldsResponseReservationTimeoutMinutesMin,
    )
    .max(
      modelHubAnnotationQueuesExportFieldsResponseReservationTimeoutMinutesMax,
    )
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
  ...
  labels: zod
    .array(
      zod.object({
        ...
        order: zod
          .number()
          .min(modelHubAnnotationQueuesExportFieldsResponseLabelsItemOrderMin)
          .max(modelHubAnnotationQueuesExportFieldsResponseLabelsItemOrderMax)
          .optional(),
      }),
    )
    .optional(),
    ...
    .array(
      zod.object({
        ...
        role: zod
          ...
          .min(1)
          .default(
            modelHubAnnotationQueuesExportFieldsResponseAnnotatorsItemRoleDefault,
          ),
        roles: zod.string().optional(),
      }),
    )
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesExportFieldsResponseLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesExportFieldsResponseAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(modelHubAnnotationQueuesExportFieldsResponseAnnotatorRolesDefault),
  label_count: zod.number().optional(),
  annotator_count: zod.number().optional(),
  item_count: zod.number().optional(),
  completed_count: zod.number().optional(),
...
export const modelHubAnnotationQueuesExportToDatasetBodyColumnMappingItemEnabledDefault =
  true;
export const modelHubAnnotationQueuesExportToDatasetBodyColumnMappingItemDefault =
  { enabled: true };
...
export const ModelHubAnnotationQueuesExportToDatasetBody = zod.object({
  ...
  status_filter: zod
    .string()
    .default(modelHubAnnotationQueuesExportToDatasetBodyStatusFilterDefault),
  column_mapping: zod
    .array(
      zod
        .object({
          ...
          enabled: zod
            .boolean()
            .default(
              modelHubAnnotationQueuesExportToDatasetBodyColumnMappingItemEnabledDefault,
            ),
        })
        .default(
          modelHubAnnotationQueuesExportToDatasetBodyColumnMappingItemDefault,
        ),
    )
    .default(modelHubAnnotationQueuesExportToDatasetBodyColumnMappingDefault),
});
...
export const modelHubAnnotationQueuesExportAnnotationsResponseNameMax = 255;

export const modelHubAnnotationQueuesExportAnnotationsResponseAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesExportAnnotationsResponseAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesExportAnnotationsResponseReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesExportAnnotationsResponseReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesExportAnnotationsResponseLabelsItemOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesExportAnnotationsResponseLabelsItemOrderMax = 2147483647;

export const modelHubAnnotationQueuesExportAnnotationsResponseAnnotatorsItemRoleDefault = `annotator`;

export const modelHubAnnotationQueuesExportAnnotationsResponseLabelIdsDefault =
  [];
export const modelHubAnnotationQueuesExportAnnotationsResponseAnnotatorIdsDefault =
  [];
export const modelHubAnnotationQueuesExportAnnotationsResponseAnnotatorRolesDefault =
  {};
...
export const ModelHubAnnotationQueuesExportAnnotationsResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesExportAnnotationsResponseNameMax),
  description: zod.string().optional(),
  instructions: zod.string().optional(),
  status: zod.enum(["draft", "active", "paused", "completed"]).optional(),
  assignment_strategy: zod
  ...
  annotations_required: zod
    .number()
    .min(
      modelHubAnnotationQueuesExportAnnotationsResponseAnnotationsRequiredMin,
    )
    .max(
      modelHubAnnotationQueuesExportAnnotationsResponseAnnotationsRequiredMax,
    )
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(
      modelHubAnnotationQueuesExportAnnotationsResponseReservationTimeoutMinutesMin,
    )
    .max(
      modelHubAnnotationQueuesExportAnnotationsResponseReservationTimeoutMinutesMax,
    )
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
    ...
    .array(
      zod.object({
        ...
        order: zod
          .number()
          .min(
            modelHubAnnotationQueuesExportAnnotationsResponseLabelsItemOrderMin,
          )
          .max(
            modelHubAnnotationQueuesExportAnnotationsResponseLabelsItemOrderMax,
          )
          .optional(),
      }),
    )
    ...
    .array(
      zod.object({
        ...
        role: zod
          ...
          .min(1)
          .default(
            modelHubAnnotationQueuesExportAnnotationsResponseAnnotatorsItemRoleDefault,
          ),
        roles: zod.string().optional(),
      }),
    )
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesExportAnnotationsResponseLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(
      modelHubAnnotationQueuesExportAnnotationsResponseAnnotatorIdsDefault,
    ),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(
      modelHubAnnotationQueuesExportAnnotationsResponseAnnotatorRolesDefault,
    ),
  label_count: zod.number().optional(),
  annotator_count: zod.number().optional(),
  item_count: zod.number().optional(),
...
export const modelHubAnnotationQueuesProgressResponseNameMax = 255;

export const modelHubAnnotationQueuesProgressResponseAnnotationsRequiredMin =
  -2147483648;
export const modelHubAnnotationQueuesProgressResponseAnnotationsRequiredMax = 2147483647;

export const modelHubAnnotationQueuesProgressResponseReservationTimeoutMinutesMin =
  -2147483648;
export const modelHubAnnotationQueuesProgressResponseReservationTimeoutMinutesMax = 2147483647;

export const modelHubAnnotationQueuesProgressResponseLabelsItemOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesProgressResponseLabelsItemOrderMax = 2147483647;

export const modelHubAnnotationQueuesProgressResponseAnnotatorsItemRoleDefault = `annotator`;

export const modelHubAnnotationQueuesProgressResponseLabelIdsDefault = [];
export const modelHubAnnotationQueuesProgressResponseAnnotatorIdsDefault = [];
export const modelHubAnnotationQueuesProgressResponseAnnotatorRolesDefault = {};
...
export const ModelHubAnnotationQueuesProgressResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesProgressResponseNameMax),
  description: zod.string().optional(),
  instructions: zod.string().optional(),
  status: zod.enum(["draft", "active", "paused", "completed"]).optional(),
  assignment_strategy: zod
  ...
  annotations_required: zod
    .number()
    .min(modelHubAnnotationQueuesProgressResponseAnnotationsRequiredMin)
    .max(modelHubAnnotationQueuesProgressResponseAnnotationsRequiredMax)
    .optional(),
  reservation_timeout_minutes: zod
    .number()
    .min(modelHubAnnotationQueuesProgressResponseReservationTimeoutMinutesMin)
    .max(modelHubAnnotationQueuesProgressResponseReservationTimeoutMinutesMax)
    .optional(),
  requires_review: zod.boolean().optional(),
  auto_assign: zod
    .boolean()
  ...
  labels: zod
    .array(
      zod.object({
        ...
        order: zod
          .number()
          .min(modelHubAnnotationQueuesProgressResponseLabelsItemOrderMin)
          .max(modelHubAnnotationQueuesProgressResponseLabelsItemOrderMax)
          .optional(),
      }),
    )
    .optional(),
    ...
    .array(
      zod.object({
        ...
        role: zod
          ...
          .min(1)
          .default(
            modelHubAnnotationQueuesProgressResponseAnnotatorsItemRoleDefault,
          ),
        roles: zod.string().optional(),
      }),
    )
  ...
  label_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesProgressResponseLabelIdsDefault),
  annotator_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesProgressResponseAnnotatorIdsDefault),
  annotator_roles: zod
    .record(zod.string(), zod.object({}).passthrough())
    .default(modelHubAnnotationQueuesProgressResponseAnnotatorRolesDefault),
  label_count: zod.number().optional(),
  annotator_count: zod.number().optional(),
  item_count: zod.number().optional(),
  completed_count: zod.number().optional(),
...
export const ModelHubAnnotationQueuesRemoveLabelBody = zod.object({
  ...
  required: zod
    .boolean()
    .default(modelHubAnnotationQueuesRemoveLabelBodyRequiredDefault),
});
...
export const ModelHubAnnotationQueuesAutomationRulesListQueryParams =
  zod.object({
    page: zod
      .number()
      .optional()
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        ...
        .min(1)
        .max(
          modelHubAnnotationQueuesAutomationRulesListResponseResultsItemNameMax,
        ),
...
export const ModelHubAnnotationQueuesAutomationRulesCreateBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesAutomationRulesCreateBodyNameMax),
  source_type: zod.enum([
    "dataset_row",
    "trace",
    "observation_span",
...
export const ModelHubAnnotationQueuesAutomationRulesReadParams = zod.object({
  ...
  id: zod
    .string()
    .uuid()
    .describe("A UUID string identifying this automation rule."),
});
...
export const ModelHubAnnotationQueuesAutomationRulesReadResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesAutomationRulesReadResponseNameMax),
  queue: zod.string().uuid().optional(),
  source_type: zod.enum([
    "dataset_row",
    "trace",
...
export const ModelHubAnnotationQueuesAutomationRulesUpdateBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationQueuesAutomationRulesUpdateBodyNameMax),
  source_type: zod.enum([
    "dataset_row",
    "trace",
    "observation_span",
...
export const ModelHubAnnotationQueuesAutomationRulesUpdateResponse = zod.object(
  {
    ...
    name: zod
      .string()
      .min(1)
      .max(modelHubAnnotationQueuesAutomationRulesUpdateResponseNameMax),
    queue: zod.string().uuid().optional(),
    source_type: zod.enum([
      "dataset_row",
      "trace",
...
export const ModelHubAnnotationQueuesAutomationRulesPartialUpdateParams =
  zod.object({
    queue_id: zod.string(),
    id: zod
      .string()
...
export const ModelHubAnnotationQueuesAutomationRulesPartialUpdateBody =
  zod.object({
    name: zod
      .string()
      .min(1)
      .max(modelHubAnnotationQueuesAutomationRulesPartialUpdateBodyNameMax),
    source_type: zod.enum([
      "dataset_row",
      "trace",
      "observation_span",
...
export const ModelHubAnnotationQueuesAutomationRulesPartialUpdateResponse =
  zod.object({
    id: zod.string().uuid().optional(),
    name: zod
      .string()
      .min(1)
      .max(modelHubAnnotationQueuesAutomationRulesPartialUpdateResponseNameMax),
    queue: zod.string().uuid().optional(),
    source_type: zod.enum([
      "dataset_row",
      "trace",
...
export const modelHubAnnotationQueuesAutomationRulesPreviewResponseNameMax = 255;

export const ModelHubAnnotationQueuesAutomationRulesPreviewResponse =
  zod.object({
    id: zod.string().uuid().optional(),
    name: zod
      .string()
      .min(1)
      .max(modelHubAnnotationQueuesAutomationRulesPreviewResponseNameMax),
    queue: zod.string().uuid().optional(),
    source_type: zod.enum([
      "dataset_row",
      "trace",
...
export const modelHubAnnotationQueuesItemsListResponseResultsItemPriorityMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsListResponseResultsItemPriorityMax = 2147483647;

export const modelHubAnnotationQueuesItemsListResponseResultsItemOrderMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesItemsListResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      priority: zod
        .number()
        .min(modelHubAnnotationQueuesItemsListResponseResultsItemPriorityMin)
        .max(modelHubAnnotationQueuesItemsListResponseResultsItemPriorityMax)
        .optional(),
      order: zod
        .number()
        .min(modelHubAnnotationQueuesItemsListResponseResultsItemOrderMin)
        .max(modelHubAnnotationQueuesItemsListResponseResultsItemOrderMax)
        .optional(),
      ...
      review_status: zod
        .string()
        .max(
          modelHubAnnotationQueuesItemsListResponseResultsItemReviewStatusMax,
        )
        .optional(),
...
export const ModelHubAnnotationQueuesItemsCreateBody = zod.object({
  ...
  priority: zod
    .number()
    .min(modelHubAnnotationQueuesItemsCreateBodyPriorityMin)
    .max(modelHubAnnotationQueuesItemsCreateBodyPriorityMax)
    .optional(),
  order: zod
    .number()
    .min(modelHubAnnotationQueuesItemsCreateBodyOrderMin)
    .max(modelHubAnnotationQueuesItemsCreateBodyOrderMax)
    .optional(),
  metadata: zod.object({}).passthrough().optional(),
  assigned_to: zod.string().uuid().optional(),
  reserved_by: zod.string().uuid().optional(),
  ...
  review_status: zod
    .string()
    .max(modelHubAnnotationQueuesItemsCreateBodyReviewStatusMax)
    .optional(),
  reviewed_by: zod.string().uuid().optional(),
  reviewed_at: zod.string().datetime({ offset: true }).optional(),
  review_notes: zod.string().optional(),
  ...
  selection: zod
    .object({
      ...
      filter: zod
        ...
        .default(
          modelHubAnnotationQueuesItemsAddItemsBodySelectionFilterDefault,
        ),
      exclude_ids: zod
      ...
      remove_simulation_calls: zod
        .boolean()
        .default(
          modelHubAnnotationQueuesItemsAddItemsBodySelectionRemoveSimulationCallsDefault,
        ),
      is_voice_call: zod
        .boolean()
        .default(
          modelHubAnnotationQueuesItemsAddItemsBodySelectionIsVoiceCallDefault,
        ),
    })
    .optional(),
});
...
export const ModelHubAnnotationQueuesItemsAssignItemsBody = zod.object({
  ...
  user_ids: zod
    .array(zod.string().uuid())
    .default(modelHubAnnotationQueuesItemsAssignItemsBodyUserIdsDefault),
  user_id: zod.string().uuid().optional(),
  action: zod
    .enum(["add", "set", "remove"])
    .default(modelHubAnnotationQueuesItemsAssignItemsBodyActionDefault),
});
...
export const modelHubAnnotationQueuesItemsNextItemResponseResultsItemPriorityMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsNextItemResponseResultsItemPriorityMax = 2147483647;

export const modelHubAnnotationQueuesItemsNextItemResponseResultsItemOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsNextItemResponseResultsItemOrderMax = 2147483647;

export const modelHubAnnotationQueuesItemsNextItemResponseResultsItemReviewStatusMax = 20;
  ...
  results: zod.array(
    zod.object({
      ...
      priority: zod
        .number()
        .min(
          modelHubAnnotationQueuesItemsNextItemResponseResultsItemPriorityMin,
        )
        .max(
          modelHubAnnotationQueuesItemsNextItemResponseResultsItemPriorityMax,
        )
        .optional(),
      order: zod
        .number()
        .min(modelHubAnnotationQueuesItemsNextItemResponseResultsItemOrderMin)
        .max(modelHubAnnotationQueuesItemsNextItemResponseResultsItemOrderMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      assigned_to: zod.string().uuid().optional(),
      assigned_to_name: zod.string().min(1).optional(),
      ...
      review_status: zod
        .string()
        .max(
          modelHubAnnotationQueuesItemsNextItemResponseResultsItemReviewStatusMax,
        )
        .optional(),
      reviewed_by: zod.string().uuid().optional(),
      reviewed_by_name: zod.string().min(1).optional(),
...
export const ModelHubAnnotationQueuesItemsReadParams = zod.object({
  ...
  id: zod
    .string()
    .uuid()
    .describe("A UUID string identifying this queue item."),
});
...
export const ModelHubAnnotationQueuesItemsReadResponse = zod.object({
  ...
  priority: zod
    .number()
    .min(modelHubAnnotationQueuesItemsReadResponsePriorityMin)
    .max(modelHubAnnotationQueuesItemsReadResponsePriorityMax)
    .optional(),
  order: zod
    .number()
    .min(modelHubAnnotationQueuesItemsReadResponseOrderMin)
    .max(modelHubAnnotationQueuesItemsReadResponseOrderMax)
    .optional(),
  metadata: zod.object({}).passthrough().optional(),
  assigned_to: zod.string().uuid().optional(),
  assigned_to_name: zod.string().min(1).optional(),
  ...
  review_status: zod
    .string()
    .max(modelHubAnnotationQueuesItemsReadResponseReviewStatusMax)
    .optional(),
  reviewed_by: zod.string().uuid().optional(),
  reviewed_by_name: zod.string().min(1).optional(),
  reviewed_at: zod.string().datetime({ offset: true }).optional(),
...
export const ModelHubAnnotationQueuesItemsUpdateBody = zod.object({
  ...
  priority: zod
    .number()
    .min(modelHubAnnotationQueuesItemsUpdateBodyPriorityMin)
    .max(modelHubAnnotationQueuesItemsUpdateBodyPriorityMax)
    .optional(),
  order: zod
    .number()
    .min(modelHubAnnotationQueuesItemsUpdateBodyOrderMin)
    .max(modelHubAnnotationQueuesItemsUpdateBodyOrderMax)
    .optional(),
  metadata: zod.object({}).passthrough().optional(),
  assigned_to: zod.string().uuid().optional(),
  reserved_by: zod.string().uuid().optional(),
  ...
  review_status: zod
    .string()
    .max(modelHubAnnotationQueuesItemsUpdateBodyReviewStatusMax)
    .optional(),
  reviewed_by: zod.string().uuid().optional(),
  reviewed_at: zod.string().datetime({ offset: true }).optional(),
  review_notes: zod.string().optional(),
...
export const modelHubAnnotationQueuesItemsUpdateResponsePriorityMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesItemsUpdateResponse = zod.object({
  ...
  priority: zod
    .number()
    .min(modelHubAnnotationQueuesItemsUpdateResponsePriorityMin)
    .max(modelHubAnnotationQueuesItemsUpdateResponsePriorityMax)
    .optional(),
  order: zod
    .number()
    .min(modelHubAnnotationQueuesItemsUpdateResponseOrderMin)
    .max(modelHubAnnotationQueuesItemsUpdateResponseOrderMax)
    .optional(),
  metadata: zod.object({}).passthrough().optional(),
  assigned_to: zod.string().uuid().optional(),
  assigned_to_name: zod.string().min(1).optional(),
  ...
  review_status: zod
    .string()
    .max(modelHubAnnotationQueuesItemsUpdateResponseReviewStatusMax)
    .optional(),
  reviewed_by: zod.string().uuid().optional(),
  reviewed_by_name: zod.string().min(1).optional(),
  reviewed_at: zod.string().datetime({ offset: true }).optional(),
...
export const modelHubAnnotationQueuesItemsPartialUpdateBodyPriorityMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsPartialUpdateBodyPriorityMax = 2147483647;

export const modelHubAnnotationQueuesItemsPartialUpdateBodyOrderMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesItemsPartialUpdateBody = zod.object({
  ...
  priority: zod
    .number()
    .min(modelHubAnnotationQueuesItemsPartialUpdateBodyPriorityMin)
    .max(modelHubAnnotationQueuesItemsPartialUpdateBodyPriorityMax)
    .optional(),
  order: zod
    .number()
    .min(modelHubAnnotationQueuesItemsPartialUpdateBodyOrderMin)
    .max(modelHubAnnotationQueuesItemsPartialUpdateBodyOrderMax)
    .optional(),
  metadata: zod.object({}).passthrough().optional(),
  assigned_to: zod.string().uuid().optional(),
  reserved_by: zod.string().uuid().optional(),
  ...
  review_status: zod
    .string()
    .max(modelHubAnnotationQueuesItemsPartialUpdateBodyReviewStatusMax)
    .optional(),
  reviewed_by: zod.string().uuid().optional(),
  reviewed_at: zod.string().datetime({ offset: true }).optional(),
  review_notes: zod.string().optional(),
...
export const modelHubAnnotationQueuesItemsPartialUpdateResponsePriorityMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsPartialUpdateResponsePriorityMax = 2147483647;

export const modelHubAnnotationQueuesItemsPartialUpdateResponseOrderMin =
  -2147483648;
...
export const ModelHubAnnotationQueuesItemsPartialUpdateResponse = zod.object({
  ...
  priority: zod
    .number()
    .min(modelHubAnnotationQueuesItemsPartialUpdateResponsePriorityMin)
    .max(modelHubAnnotationQueuesItemsPartialUpdateResponsePriorityMax)
    .optional(),
  order: zod
    .number()
    .min(modelHubAnnotationQueuesItemsPartialUpdateResponseOrderMin)
    .max(modelHubAnnotationQueuesItemsPartialUpdateResponseOrderMax)
    .optional(),
  metadata: zod.object({}).passthrough().optional(),
  assigned_to: zod.string().uuid().optional(),
  assigned_to_name: zod.string().min(1).optional(),
  ...
  review_status: zod
    .string()
    .max(modelHubAnnotationQueuesItemsPartialUpdateResponseReviewStatusMax)
    .optional(),
  reviewed_by: zod.string().uuid().optional(),
  reviewed_by_name: zod.string().min(1).optional(),
  reviewed_at: zod.string().datetime({ offset: true }).optional(),
...
export const ModelHubAnnotationQueuesItemsAnnotateDetailQueryParams =
  zod.object({
...
export const modelHubAnnotationQueuesItemsAnnotateDetailResponsePriorityMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsAnnotateDetailResponsePriorityMax = 2147483647;

export const modelHubAnnotationQueuesItemsAnnotateDetailResponseOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsAnnotateDetailResponseOrderMax = 2147483647;

export const modelHubAnnotationQueuesItemsAnnotateDetailResponseReviewStatusMax = 20;
...
export const ModelHubAnnotationQueuesItemsAnnotateDetailResponse = zod.object({
  ...
  priority: zod
    .number()
    .min(modelHubAnnotationQueuesItemsAnnotateDetailResponsePriorityMin)
    .max(modelHubAnnotationQueuesItemsAnnotateDetailResponsePriorityMax)
    .optional(),
  order: zod
    .number()
    .min(modelHubAnnotationQueuesItemsAnnotateDetailResponseOrderMin)
    .max(modelHubAnnotationQueuesItemsAnnotateDetailResponseOrderMax)
    .optional(),
  metadata: zod.object({}).passthrough().optional(),
  assigned_to: zod.string().uuid().optional(),
  assigned_to_name: zod.string().min(1).optional(),
  ...
  review_status: zod
    .string()
    .max(modelHubAnnotationQueuesItemsAnnotateDetailResponseReviewStatusMax)
    .optional(),
  reviewed_by: zod.string().uuid().optional(),
  reviewed_by_name: zod.string().min(1).optional(),
  reviewed_at: zod.string().datetime({ offset: true }).optional(),
...
export const modelHubAnnotationQueuesItemsAnnotationsListResponsePriorityMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsAnnotationsListResponsePriorityMax = 2147483647;

export const modelHubAnnotationQueuesItemsAnnotationsListResponseOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsAnnotationsListResponseOrderMax = 2147483647;

export const modelHubAnnotationQueuesItemsAnnotationsListResponseReviewStatusMax = 20;
...
export const ModelHubAnnotationQueuesItemsAnnotationsListResponse = zod.object({
  ...
  priority: zod
    .number()
    .min(modelHubAnnotationQueuesItemsAnnotationsListResponsePriorityMin)
    .max(modelHubAnnotationQueuesItemsAnnotationsListResponsePriorityMax)
    .optional(),
  order: zod
    .number()
    .min(modelHubAnnotationQueuesItemsAnnotationsListResponseOrderMin)
    .max(modelHubAnnotationQueuesItemsAnnotationsListResponseOrderMax)
    .optional(),
  metadata: zod.object({}).passthrough().optional(),
  assigned_to: zod.string().uuid().optional(),
  assigned_to_name: zod.string().min(1).optional(),
  ...
  review_status: zod
    .string()
    .max(modelHubAnnotationQueuesItemsAnnotationsListResponseReviewStatusMax)
    .optional(),
  reviewed_by: zod.string().uuid().optional(),
  reviewed_by_name: zod.string().min(1).optional(),
  reviewed_at: zod.string().datetime({ offset: true }).optional(),
 ...
 */
export const ModelHubAnnotationQueuesItemsAnnotationsImportAnnotationsParams =
  zod.object({
    queue_id: zod.string(),
    id: zod
      .string()
...
export const ModelHubAnnotationQueuesItemsAnnotationsImportAnnotationsBody =
  zod.object({
 ...
 */
export const ModelHubAnnotationQueuesItemsAnnotationsSubmitAnnotationsParams =
  zod.object({
    queue_id: zod.string(),
    id: zod
      .string()
...
export const ModelHubAnnotationQueuesItemsAnnotationsSubmitAnnotationsBody =
  zod.object({
    annotations: zod.array(zod.record(zod.string(), zod.string())).min(1),
    notes: zod
      .string()
      .default(
        modelHubAnnotationQueuesItemsAnnotationsSubmitAnnotationsBodyNotesDefault,
      ),
...
export const modelHubAnnotationQueuesItemsCompleteItemBodyIncludeCompletedDefault =
  false;

export const ModelHubAnnotationQueuesItemsCompleteItemBody = zod.object({
  exclude: zod
    .array(zod.string().min(1))
    .default(modelHubAnnotationQueuesItemsCompleteItemBodyExcludeDefault),
  exclude_review_status: zod.string().optional(),
  include_completed: zod
    .boolean()
    .default(
      modelHubAnnotationQueuesItemsCompleteItemBodyIncludeCompletedDefault,
    ),
});
...
export const modelHubAnnotationQueuesItemsDiscussionReadResponsePriorityMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsDiscussionReadResponsePriorityMax = 2147483647;

export const modelHubAnnotationQueuesItemsDiscussionReadResponseOrderMin =
  -2147483648;
export const modelHubAnnotationQueuesItemsDiscussionReadResponseOrderMax = 2147483647;

export const modelHubAnnotationQueuesItemsDiscussionReadResponseReviewStatusMax = 20;
...
export const ModelHubAnnotationQueuesItemsDiscussionReadResponse = zod.object({
  ...
  priority: zod
    .number()
    .min(modelHubAnnotationQueuesItemsDiscussionReadResponsePriorityMin)
    .max(modelHubAnnotationQueuesItemsDiscussionReadResponsePriorityMax)
    .optional(),
  order: zod
    .number()
    .min(modelHubAnnotationQueuesItemsDiscussionReadResponseOrderMin)
    .max(modelHubAnnotationQueuesItemsDiscussionReadResponseOrderMax)
    .optional(),
  metadata: zod.object({}).passthrough().optional(),
  assigned_to: zod.string().uuid().optional(),
  assigned_to_name: zod.string().min(1).optional(),
  ...
  review_status: zod
    .string()
    .max(modelHubAnnotationQueuesItemsDiscussionReadResponseReviewStatusMax)
    .optional(),
  reviewed_by: zod.string().uuid().optional(),
  reviewed_by_name: zod.string().min(1).optional(),
  reviewed_at: zod.string().datetime({ offset: true }).optional(),
 ...
 */
export const ModelHubAnnotationQueuesItemsDiscussionCommentsDiscussionCommentReactionParams =
  zod.object({
    queue_id: zod.string(),
    id: zod
      .string()
...
export const ModelHubAnnotationQueuesItemsDiscussionCommentsDiscussionCommentReactionBody =
  zod.object({
    emoji: zod
      .string()
      .max(
        modelHubAnnotationQueuesItemsDiscussionCommentsDiscussionCommentReactionBodyEmojiMax,
      )
      .optional(),
    reaction: zod
      .string()
      .max(
        modelHubAnnotationQueuesItemsDiscussionCommentsDiscussionCommentReactionBodyReactionMax,
      )
      .optional(),
  });

export const ModelHubAnnotationQueuesItemsDiscussionReopenDiscussionThreadParams =
  zod.object({
    queue_id: zod.string(),
    id: zod
      .string()
...
export const ModelHubAnnotationQueuesItemsDiscussionReopenDiscussionThreadBody =
  zod.object({
    comment: zod.string().optional(),
  });

export const ModelHubAnnotationQueuesItemsDiscussionResolveDiscussionThreadParams =
  zod.object({
    queue_id: zod.string(),
    id: zod
      .string()
...
export const ModelHubAnnotationQueuesItemsDiscussionResolveDiscussionThreadBody =
  zod.object({
    comment: zod.string().optional(),
  });
  ...
  label_comments: zod
    .array(
      zod
        ...
        .default(
          modelHubAnnotationQueuesItemsReviewItemBodyLabelCommentsItemDefault,
        ),
    )
    .default(modelHubAnnotationQueuesItemsReviewItemBodyLabelCommentsDefault),
});
...
export const modelHubAnnotationQueuesItemsSkipItemBodyIncludeCompletedDefault =
  false;

export const ModelHubAnnotationQueuesItemsSkipItemBody = zod.object({
  exclude: zod
    .array(zod.string().min(1))
    .default(modelHubAnnotationQueuesItemsSkipItemBodyExcludeDefault),
  exclude_review_status: zod.string().optional(),
  include_completed: zod
    .boolean()
    .default(modelHubAnnotationQueuesItemsSkipItemBodyIncludeCompletedDefault),
});
...
export const modelHubAnnotationTasksListResponseResultsItemAiModelDeletedDefault =
  false;
  ...
  results: zod.array(
    zod.object({
        ...
        .array(
          zod.object({
            ...
            email: zod
              ...
              .min(1)
              .max(
                modelHubAnnotationTasksListResponseResultsItemAssignedUsersItemEmailMax,
              ),
            name: zod
              .string()
              .min(1)
              .max(
                modelHubAnnotationTasksListResponseResultsItemAssignedUsersItemNameMax,
              ),
            ...
            organization: zod
              .object({
                ...
                name: zod
                  ...
                  .min(1)
                  .max(
                    modelHubAnnotationTasksListResponseResultsItemAssignedUsersItemOrganizationNameMax,
                  ),
                display_name: zod
                  .string()
                  .max(
                    modelHubAnnotationTasksListResponseResultsItemAssignedUsersItemOrganizationDisplayNameMax,
                  )
                  .optional(),
                ...
                region: zod
                  ...
                  .min(1)
                  .max(
                    modelHubAnnotationTasksListResponseResultsItemAssignedUsersItemOrganizationRegionMax,
                  )
                  .optional(),
                ...
                require_2fa_grace_period_days: zod
                  .number()
                  .min(
                    modelHubAnnotationTasksListResponseResultsItemAssignedUsersItemOrganizationRequire2faGracePeriodDaysMin,
                  )
                  .max(
                    modelHubAnnotationTasksListResponseResultsItemAssignedUsersItemOrganizationRequire2faGracePeriodDaysMax,
                  )
                  .optional(),
            ...
            role: zod
              .string()
              .max(
                modelHubAnnotationTasksListResponseResultsItemAssignedUsersItemRoleMax,
              )
              .optional()
              .describe(
      ...
      ai_model: zod
        .object({
            ...
            .array(
              zod.object({
                ...
                status: zod
                  .boolean()
                  .optional()
                  .describe("Indicates if the alert is executed"),
                name: zod
                  .string()
                  .min(1)
                  .max(
                    modelHubAnnotationTasksListResponseResultsItemAiModelMonitorsItemNameMax,
                  )
                  .describe("Name of the monitor"),
                monitor_type: zod.enum([
                  "Analytics",
                  "DataDrift",
                  "Performance",
                ]),
                dimension: zod
                  ...
                  .min(1)
                  .max(
                    modelHubAnnotationTasksListResponseResultsItemAiModelMonitorsItemDimensionMax,
                  )
                  .describe("Dimension of the monitor"),
                metric: zod
                  .string()
                  .min(1)
                  .max(
                    modelHubAnnotationTasksListResponseResultsItemAiModelMonitorsItemMetricMax,
                  )
                  .describe("Metric used by the monitor"),
                current_value: zod
                  .number()
                  .describe("Current value of the metric"),
                trigger_value: zod
                  .number()
                  .describe("Value at which the alert is triggered"),
                is_mute: zod
                  .boolean()
                  .optional()
                  .describe("Indicates if the monitor is muted"),
                created_at: zod.string().datetime({ offset: true }).optional(),
                updated_at: zod.string().datetime({ offset: true }).optional(),
              }),
            )
          ...
          user_model_id: zod
            ...
            .min(1)
            .max(
              modelHubAnnotationTasksListResponseResultsItemAiModelUserModelIdMax,
            ),
          deleted: zod
            .boolean()
            .default(
              modelHubAnnotationTasksListResponseResultsItemAiModelDeletedDefault,
            ),
          model_type: zod.enum([
            "Numeric",
            "ScoreCategorical",
          ...
          baseline_model_environment: zod
            .enum(["Production", "Training", "Validation", "Corpus"])
            .optional(),
          baseline_model_version: zod
            .string()
            .max(
              modelHubAnnotationTasksListResponseResultsItemAiModelBaselineModelVersionMax,
            )
            .optional(),
      ...
      task_name: zod
        .string()
        .min(1)
        .max(modelHubAnnotationTasksListResponseResultsItemTaskNameMax),
    }),
  ),
});
...
export const ModelHubAnnotationTasksReadResponse = zod.object({
    ...
    .array(
      zod.object({
        ...
        email: zod
          ...
          .email()
          .min(1)
          .max(modelHubAnnotationTasksReadResponseAssignedUsersItemEmailMax),
        name: zod
          .string()
          .min(1)
          .max(modelHubAnnotationTasksReadResponseAssignedUsersItemNameMax),
        organization_role: zod
          .enum([
            "Owner",
            "Admin",
        ...
        organization: zod
          .object({
            ...
            name: zod
              ...
              .min(1)
              .max(
                modelHubAnnotationTasksReadResponseAssignedUsersItemOrganizationNameMax,
              ),
            display_name: zod
              .string()
              .max(
                modelHubAnnotationTasksReadResponseAssignedUsersItemOrganizationDisplayNameMax,
              )
              .optional(),
            is_new: zod.boolean().optional(),
            ws_enabled: zod.boolean().optional(),
            region: zod
              ...
              .min(1)
              .max(
                modelHubAnnotationTasksReadResponseAssignedUsersItemOrganizationRegionMax,
              )
              .optional(),
            require_2fa: zod.boolean().optional(),
            require_2fa_grace_period_days: zod
              .number()
              .min(
                modelHubAnnotationTasksReadResponseAssignedUsersItemOrganizationRequire2faGracePeriodDaysMin,
              )
              .max(
                modelHubAnnotationTasksReadResponseAssignedUsersItemOrganizationRequire2faGracePeriodDaysMax,
              )
              .optional(),
            require_2fa_enforced_at: zod
              .string()
        ...
        role: zod
          .string()
          .max(modelHubAnnotationTasksReadResponseAssignedUsersItemRoleMax)
          .optional()
          .describe(
            "User's job role (e.g., Data Scientist, ML Engineer, or custom role)",
          ),
  ...
  ai_model: zod
    .object({
        ...
        .array(
          zod.object({
            ...
            name: zod
              ...
              .min(1)
              .max(
                modelHubAnnotationTasksReadResponseAiModelMonitorsItemNameMax,
              )
              .describe("Name of the monitor"),
            ...
            dimension: zod
              ...
              .min(1)
              .max(
                modelHubAnnotationTasksReadResponseAiModelMonitorsItemDimensionMax,
              )
              .describe("Dimension of the monitor"),
            metric: zod
              .string()
              .min(1)
              .max(
                modelHubAnnotationTasksReadResponseAiModelMonitorsItemMetricMax,
              )
              .describe("Metric used by the monitor"),
      ...
      user_model_id: zod
        .string()
        .min(1)
        .max(modelHubAnnotationTasksReadResponseAiModelUserModelIdMax),
      deleted: zod
        .boolean()
        .default(modelHubAnnotationTasksReadResponseAiModelDeletedDefault),
      model_type: zod.enum([
        "Numeric",
        "ScoreCategorical",
        "Ranking",
      ...
      baseline_model_version: zod
        .string()
        .max(modelHubAnnotationTasksReadResponseAiModelBaselineModelVersionMax)
        .optional(),
      default_metric: zod.string().uuid().optional(),
      organization: zod.string().uuid(),
      workspace: zod.string().uuid().optional(),
  ...
  task_name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationTasksReadResponseTaskNameMax),
});
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(modelHubAnnotationsLabelsListResponseResultsItemNameMax),
      type: zod.enum([
        "text",
        "numeric",
        "categorical",
...
export const ModelHubAnnotationsLabelsPartialUpdateBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationsLabelsPartialUpdateBodyNameMax),
  type: zod.enum(["text", "numeric", "categorical", "star", "thumbs_up_down"]),
  settings: zod.object({}).passthrough().optional(),
  project: zod.string().uuid().optional(),
  description: zod.string().optional(),
...
export const ModelHubAnnotationsLabelsPartialUpdateResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationsLabelsPartialUpdateResponseNameMax),
  type: zod.enum(["text", "numeric", "categorical", "star", "thumbs_up_down"]),
  organization: zod.string().uuid().optional(),
  settings: zod.object({}).passthrough().optional(),
  project: zod.string().uuid().optional(),
...
export const modelHubAnnotationsListResponseResultsItemResponsesMin =
  -2147483648;
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(modelHubAnnotationsListResponseResultsItemNameMax),
      assigned_users: zod.string().optional(),
      organization: zod.string().uuid().optional(),
      labels: zod.string().optional(),
      columns: zod.array(zod.string().uuid()).optional(),
      static_fields: zod.object({}).passthrough().optional(),
      response_fields: zod.object({}).passthrough().optional(),
      dataset: zod.string().uuid().optional(),
      summary: zod.string().optional(),
      created_at: zod.string().datetime({ offset: true }).optional(),
      responses: zod
        .number()
        .min(modelHubAnnotationsListResponseResultsItemResponsesMin)
        .max(modelHubAnnotationsListResponseResultsItemResponsesMax)
        .optional(),
...
export const ModelHubAnnotationsCreateBody = zod.object({
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsCreateBodyResponsesMin)
    .max(modelHubAnnotationsCreateBodyResponsesMax)
    .optional(),
});
...
export const ModelHubAnnotationsBulkDestroyBody = zod.object({
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsBulkDestroyBodyResponsesMin)
    .max(modelHubAnnotationsBulkDestroyBodyResponsesMax)
    .optional(),
});
...
export const modelHubAnnotationsPreviewAnnotationsBodyResponsesMin =
  -2147483648;
...
export const ModelHubAnnotationsPreviewAnnotationsBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationsPreviewAnnotationsBodyNameMax),
  columns: zod.array(zod.string().uuid()).optional(),
  static_fields: zod.object({}).passthrough().optional(),
  response_fields: zod.object({}).passthrough().optional(),
  dataset: zod.string().uuid().optional(),
  responses: zod
    .number()
    .min(modelHubAnnotationsPreviewAnnotationsBodyResponsesMin)
    .max(modelHubAnnotationsPreviewAnnotationsBodyResponsesMax)
    .optional(),
});
...
export const ModelHubAnnotationsReadResponse = zod.object({
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsReadResponseResponsesMin)
    .max(modelHubAnnotationsReadResponseResponsesMax)
    .optional(),
  lowest_unfinished_row: zod.string().optional(),
  label_requirements: zod.string().optional(),
});
...
export const ModelHubAnnotationsUpdateBody = zod.object({
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsUpdateBodyResponsesMin)
    .max(modelHubAnnotationsUpdateBodyResponsesMax)
    .optional(),
});
...
export const ModelHubAnnotationsUpdateResponse = zod.object({
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsUpdateResponseResponsesMin)
    .max(modelHubAnnotationsUpdateResponseResponsesMax)
    .optional(),
  lowest_unfinished_row: zod.string().optional(),
  label_requirements: zod.string().optional(),
});
...
export const ModelHubAnnotationsPartialUpdateBody = zod.object({
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsPartialUpdateBodyResponsesMin)
    .max(modelHubAnnotationsPartialUpdateBodyResponsesMax)
    .optional(),
});
...
export const ModelHubAnnotationsPartialUpdateResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(modelHubAnnotationsPartialUpdateResponseNameMax),
  assigned_users: zod.string().optional(),
  organization: zod.string().uuid().optional(),
  labels: zod.string().optional(),
  columns: zod.array(zod.string().uuid()).optional(),
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsPartialUpdateResponseResponsesMin)
    .max(modelHubAnnotationsPartialUpdateResponseResponsesMax)
    .optional(),
  lowest_unfinished_row: zod.string().optional(),
  label_requirements: zod.string().optional(),
});
...
export const ModelHubAnnotationsAnnotateRowResponse = zod.object({
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsAnnotateRowResponseResponsesMin)
    .max(modelHubAnnotationsAnnotateRowResponseResponsesMax)
    .optional(),
  lowest_unfinished_row: zod.string().optional(),
  label_requirements: zod.string().optional(),
});
...
export const ModelHubAnnotationsResetAnnotationsBody = zod.object({
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsResetAnnotationsBodyResponsesMin)
    .max(modelHubAnnotationsResetAnnotationsBodyResponsesMax)
    .optional(),
});
...
export const ModelHubAnnotationsUpdateCellsBody = zod.object({
  ...
  responses: zod
    .number()
    .min(modelHubAnnotationsUpdateCellsBodyResponsesMin)
    .max(modelHubAnnotationsUpdateCellsBodyResponsesMax)
    .optional(),
});
...
export const ModelHubScoresListResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      label_settings: zod.object({}).passthrough().optional(),
...
export const ModelHubScoresCreateBody = zod.object({
  ...
  score_source: zod
    .enum(["human", "api", "auto", "imported"])
    .default(modelHubScoresCreateBodyScoreSourceDefault),
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(tracerDashboardFilterValuesResponseResultsItemNameMax),
      description: zod.string().optional(),
      workspace: zod.string().uuid().optional(),
      created_by: zod
        .object({
          ...
          email: zod
            ...
            .min(1)
            .max(
              tracerDashboardFilterValuesResponseResultsItemCreatedByEmailMax,
            ),
          name: zod
            .string()
            .min(1)
            .max(
              tracerDashboardFilterValuesResponseResultsItemCreatedByNameMax,
            ),
          organization_role: zod
            .enum([
              "Owner",
          ...
          organization: zod
            .object({
              ...
              name: zod
                ...
                .min(1)
                .max(
                  tracerDashboardFilterValuesResponseResultsItemCreatedByOrganizationNameMax,
                ),
              display_name: zod
                .string()
                .max(
                  tracerDashboardFilterValuesResponseResultsItemCreatedByOrganizationDisplayNameMax,
                )
                .optional(),
              is_new: zod.boolean().optional(),
              ws_enabled: zod.boolean().optional(),
              region: zod
                ...
                .min(1)
                .max(
                  tracerDashboardFilterValuesResponseResultsItemCreatedByOrganizationRegionMax,
                )
                .optional(),
              require_2fa: zod.boolean().optional(),
              require_2fa_grace_period_days: zod
                .number()
                .min(
                  tracerDashboardFilterValuesResponseResultsItemCreatedByOrganizationRequire2faGracePeriodDaysMin,
                )
                .max(
                  tracerDashboardFilterValuesResponseResultsItemCreatedByOrganizationRequire2faGracePeriodDaysMax,
                )
                .optional(),
              require_2fa_enforced_at: zod
                .string()
          ...
          role: zod
            .string()
            .max(tracerDashboardFilterValuesResponseResultsItemCreatedByRoleMax)
            .optional()
            .describe(
              "User's job role (e.g., Data Scientist, ML Engineer, or custom role)",
            ),
      ...
      updated_by: zod
        .object({
          ...
          email: zod
            ...
            .min(1)
            .max(
              tracerDashboardFilterValuesResponseResultsItemUpdatedByEmailMax,
            ),
          name: zod
            .string()
            .min(1)
            .max(
              tracerDashboardFilterValuesResponseResultsItemUpdatedByNameMax,
            ),
          organization_role: zod
            .enum([
              "Owner",
          ...
          organization: zod
            .object({
              ...
              name: zod
                ...
                .min(1)
                .max(
                  tracerDashboardFilterValuesResponseResultsItemUpdatedByOrganizationNameMax,
                ),
              display_name: zod
                .string()
                .max(
                  tracerDashboardFilterValuesResponseResultsItemUpdatedByOrganizationDisplayNameMax,
                )
                .optional(),
              is_new: zod.boolean().optional(),
              ws_enabled: zod.boolean().optional(),
              region: zod
                ...
                .min(1)
                .max(
                  tracerDashboardFilterValuesResponseResultsItemUpdatedByOrganizationRegionMax,
                )
                .optional(),
              require_2fa: zod.boolean().optional(),
              require_2fa_grace_period_days: zod
                .number()
                .min(
                  tracerDashboardFilterValuesResponseResultsItemUpdatedByOrganizationRequire2faGracePeriodDaysMin,
                )
                .max(
                  tracerDashboardFilterValuesResponseResultsItemUpdatedByOrganizationRequire2faGracePeriodDaysMax,
                )
                .optional(),
              require_2fa_enforced_at: zod
                .string()
          ...
          role: zod
            .string()
            .max(tracerDashboardFilterValuesResponseResultsItemUpdatedByRoleMax)
            .optional()
            .describe(
              "User's job role (e.g., Data Scientist, ML Engineer, or custom role)",
            ),
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(tracerDashboardMetricsResponseResultsItemNameMax),
      description: zod.string().optional(),
      workspace: zod.string().uuid().optional(),
      created_by: zod
        .object({
          ...
          email: zod
            ...
            .email()
            .min(1)
            .max(tracerDashboardMetricsResponseResultsItemCreatedByEmailMax),
          name: zod
            .string()
            .min(1)
            .max(tracerDashboardMetricsResponseResultsItemCreatedByNameMax),
          organization_role: zod
            .enum([
              "Owner",
              "Admin",
          ...
          organization: zod
            .object({
              ...
              name: zod
                ...
                .min(1)
                .max(
                  tracerDashboardMetricsResponseResultsItemCreatedByOrganizationNameMax,
                ),
              display_name: zod
                .string()
                .max(
                  tracerDashboardMetricsResponseResultsItemCreatedByOrganizationDisplayNameMax,
                )
                .optional(),
              is_new: zod.boolean().optional(),
              ws_enabled: zod.boolean().optional(),
              region: zod
                ...
                .min(1)
                .max(
                  tracerDashboardMetricsResponseResultsItemCreatedByOrganizationRegionMax,
                )
                .optional(),
              require_2fa: zod.boolean().optional(),
              require_2fa_grace_period_days: zod
                .number()
                .min(
                  tracerDashboardMetricsResponseResultsItemCreatedByOrganizationRequire2faGracePeriodDaysMin,
                )
                .max(
                  tracerDashboardMetricsResponseResultsItemCreatedByOrganizationRequire2faGracePeriodDaysMax,
                )
                .optional(),
              require_2fa_enforced_at: zod
                .string()
          ...
          role: zod
            .string()
            .max(tracerDashboardMetricsResponseResultsItemCreatedByRoleMax)
            .optional()
            .describe(
              "User's job role (e.g., Data Scientist, ML Engineer, or custom role)",
            ),
      ...
      updated_by: zod
        .object({
          ...
          email: zod
            ...
            .email()
            .min(1)
            .max(tracerDashboardMetricsResponseResultsItemUpdatedByEmailMax),
          name: zod
            .string()
            .min(1)
            .max(tracerDashboardMetricsResponseResultsItemUpdatedByNameMax),
          organization_role: zod
            .enum([
              "Owner",
              "Admin",
          ...
          organization: zod
            .object({
              ...
              name: zod
                ...
                .min(1)
                .max(
                  tracerDashboardMetricsResponseResultsItemUpdatedByOrganizationNameMax,
                ),
              display_name: zod
                .string()
                .max(
                  tracerDashboardMetricsResponseResultsItemUpdatedByOrganizationDisplayNameMax,
                )
                .optional(),
              is_new: zod.boolean().optional(),
              ws_enabled: zod.boolean().optional(),
              region: zod
                ...
                .min(1)
                .max(
                  tracerDashboardMetricsResponseResultsItemUpdatedByOrganizationRegionMax,
                )
                .optional(),
              require_2fa: zod.boolean().optional(),
              require_2fa_grace_period_days: zod
                .number()
                .min(
                  tracerDashboardMetricsResponseResultsItemUpdatedByOrganizationRequire2faGracePeriodDaysMin,
                )
                .max(
                  tracerDashboardMetricsResponseResultsItemUpdatedByOrganizationRequire2faGracePeriodDaysMax,
                )
                .optional(),
              require_2fa_enforced_at: zod
                .string()
          ...
          role: zod
            .string()
            .max(tracerDashboardMetricsResponseResultsItemUpdatedByRoleMax)
            .optional()
            .describe(
              "User's job role (e.g., Data Scientist, ML Engineer, or custom role)",
            ),
  ...
  created_by: zod
    .object({
      ...
      email: zod
        ...
        .email()
        .min(1)
        .max(tracerDashboardQueryBodyCreatedByEmailMax),
      ...
      organization: zod
        .object({
          ...
          name: zod
            .string()
            .min(1)
            .max(tracerDashboardQueryBodyCreatedByOrganizationNameMax),
          display_name: zod
            .string()
            .max(tracerDashboardQueryBodyCreatedByOrganizationDisplayNameMax)
            .optional(),
          is_new: zod.boolean().optional(),
          ws_enabled: zod.boolean().optional(),
          region: zod
            .string()
            .min(1)
            .max(tracerDashboardQueryBodyCreatedByOrganizationRegionMax)
            .optional(),
          require_2fa: zod.boolean().optional(),
          require_2fa_grace_period_days: zod
            .number()
            .min(
              tracerDashboardQueryBodyCreatedByOrganizationRequire2faGracePeriodDaysMin,
            )
            .max(
              tracerDashboardQueryBodyCreatedByOrganizationRequire2faGracePeriodDaysMax,
            )
            .optional(),
          require_2fa_enforced_at: zod
            .string()
      ...
      role: zod
        .string()
        .max(tracerDashboardQueryBodyCreatedByRoleMax)
        .optional()
        .describe(
          "User's job role (e.g., Data Scientist, ML Engineer, or custom role)",
        ),
  ...
  updated_by: zod
    .object({
      ...
      email: zod
        ...
        .email()
        .min(1)
        .max(tracerDashboardQueryBodyUpdatedByEmailMax),
      ...
      organization: zod
        .object({
          ...
          name: zod
            .string()
            .min(1)
            .max(tracerDashboardQueryBodyUpdatedByOrganizationNameMax),
          display_name: zod
            .string()
            .max(tracerDashboardQueryBodyUpdatedByOrganizationDisplayNameMax)
            .optional(),
          is_new: zod.boolean().optional(),
          ws_enabled: zod.boolean().optional(),
          region: zod
            .string()
            .min(1)
            .max(tracerDashboardQueryBodyUpdatedByOrganizationRegionMax)
            .optional(),
          require_2fa: zod.boolean().optional(),
          require_2fa_grace_period_days: zod
            .number()
            .min(
              tracerDashboardQueryBodyUpdatedByOrganizationRequire2faGracePeriodDaysMin,
            )
            .max(
              tracerDashboardQueryBodyUpdatedByOrganizationRequire2faGracePeriodDaysMax,
            )
            .optional(),
          require_2fa_enforced_at: zod
            .string()
      ...
      role: zod
        .string()
        .max(tracerDashboardQueryBodyUpdatedByRoleMax)
        .optional()
        .describe(
          "User's job role (e.g., Data Scientist, ML Engineer, or custom role)",
        ),
...
export const tracerDashboardWidgetsListResponseResultsItemPositionMin =
  -2147483648;
export const tracerDashboardWidgetsListResponseResultsItemPositionMax = 2147483647;

export const tracerDashboardWidgetsListResponseResultsItemWidthMin =
  -2147483648;
export const tracerDashboardWidgetsListResponseResultsItemWidthMax = 2147483647;

export const tracerDashboardWidgetsListResponseResultsItemHeightMin =
  -2147483648;
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(tracerDashboardWidgetsListResponseResultsItemNameMax)
        .optional(),
      description: zod.string().optional(),
      position: zod
        .number()
        .min(tracerDashboardWidgetsListResponseResultsItemPositionMin)
        .max(tracerDashboardWidgetsListResponseResultsItemPositionMax)
        .optional(),
      width: zod
        .number()
        .min(tracerDashboardWidgetsListResponseResultsItemWidthMin)
        .max(tracerDashboardWidgetsListResponseResultsItemWidthMax)
        .optional(),
      height: zod
        .number()
...
export const TracerDashboardWidgetsCreateBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsCreateBodyNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsCreateBodyPositionMin)
    .max(tracerDashboardWidgetsCreateBodyPositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsCreateBodyWidthMin)
    .max(tracerDashboardWidgetsCreateBodyWidthMax)
    .optional(),
  height: zod
    .number()
...
export const TracerDashboardWidgetsPreviewQueryBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsPreviewQueryBodyNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsPreviewQueryBodyPositionMin)
    .max(tracerDashboardWidgetsPreviewQueryBodyPositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsPreviewQueryBodyWidthMin)
    .max(tracerDashboardWidgetsPreviewQueryBodyWidthMax)
    .optional(),
  height: zod
    .number()
    .min(tracerDashboardWidgetsPreviewQueryBodyHeightMin)
    .max(tracerDashboardWidgetsPreviewQueryBodyHeightMax)
    .optional(),
  query_config: zod.object({}).passthrough().optional(),
  chart_config: zod.object({}).passthrough().optional(),
});
...
export const TracerDashboardWidgetsReorderBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsReorderBodyNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsReorderBodyPositionMin)
    .max(tracerDashboardWidgetsReorderBodyPositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsReorderBodyWidthMin)
    .max(tracerDashboardWidgetsReorderBodyWidthMax)
    .optional(),
  height: zod
    .number()
...
export const TracerDashboardWidgetsReadResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsReadResponseNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsReadResponsePositionMin)
    .max(tracerDashboardWidgetsReadResponsePositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsReadResponseWidthMin)
    .max(tracerDashboardWidgetsReadResponseWidthMax)
    .optional(),
  height: zod
    .number()
...
export const TracerDashboardWidgetsUpdateBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsUpdateBodyNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsUpdateBodyPositionMin)
    .max(tracerDashboardWidgetsUpdateBodyPositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsUpdateBodyWidthMin)
    .max(tracerDashboardWidgetsUpdateBodyWidthMax)
    .optional(),
  height: zod
    .number()
...
export const TracerDashboardWidgetsUpdateResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsUpdateResponseNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsUpdateResponsePositionMin)
    .max(tracerDashboardWidgetsUpdateResponsePositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsUpdateResponseWidthMin)
    .max(tracerDashboardWidgetsUpdateResponseWidthMax)
    .optional(),
  height: zod
    .number()
...
export const TracerDashboardWidgetsPartialUpdateBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsPartialUpdateBodyNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsPartialUpdateBodyPositionMin)
    .max(tracerDashboardWidgetsPartialUpdateBodyPositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsPartialUpdateBodyWidthMin)
    .max(tracerDashboardWidgetsPartialUpdateBodyWidthMax)
    .optional(),
  height: zod
    .number()
...
export const tracerDashboardWidgetsPartialUpdateResponsePositionMin =
  -2147483648;
...
export const TracerDashboardWidgetsPartialUpdateResponse = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsPartialUpdateResponseNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsPartialUpdateResponsePositionMin)
    .max(tracerDashboardWidgetsPartialUpdateResponsePositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsPartialUpdateResponseWidthMin)
    .max(tracerDashboardWidgetsPartialUpdateResponseWidthMax)
    .optional(),
  height: zod
    .number()
...
export const TracerDashboardWidgetsDuplicateWidgetBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsDuplicateWidgetBodyNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsDuplicateWidgetBodyPositionMin)
    .max(tracerDashboardWidgetsDuplicateWidgetBodyPositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsDuplicateWidgetBodyWidthMin)
    .max(tracerDashboardWidgetsDuplicateWidgetBodyWidthMax)
    .optional(),
  height: zod
    .number()
...
export const TracerDashboardWidgetsExecuteQueryBody = zod.object({
  name: zod
    .string()
    .min(1)
    .max(tracerDashboardWidgetsExecuteQueryBodyNameMax)
    .optional(),
  description: zod.string().optional(),
  position: zod
    .number()
    .min(tracerDashboardWidgetsExecuteQueryBodyPositionMin)
    .max(tracerDashboardWidgetsExecuteQueryBodyPositionMax)
    .optional(),
  width: zod
    .number()
    .min(tracerDashboardWidgetsExecuteQueryBodyWidthMin)
    .max(tracerDashboardWidgetsExecuteQueryBodyWidthMax)
    .optional(),
  height: zod
    .number()
    .min(tracerDashboardWidgetsExecuteQueryBodyHeightMin)
    .max(tracerDashboardWidgetsExecuteQueryBodyHeightMax)
    .optional(),
  query_config: zod.object({}).passthrough().optional(),
  chart_config: zod.object({}).passthrough().optional(),
});
  ...
  created_by: zod
    .object({
      ...
      email: zod
        ...
        .email()
        .min(1)
        .max(tracerDashboardReadResponseCreatedByEmailMax),
      name: zod
        .string()
        .min(1)
        .max(tracerDashboardReadResponseCreatedByNameMax),
      organization_role: zod
        .enum([
          "Owner",
          "Admin",
      ...
      organization: zod
        .object({
          ...
          name: zod
            .string()
            .min(1)
            .max(tracerDashboardReadResponseCreatedByOrganizationNameMax),
          display_name: zod
            .string()
            .max(tracerDashboardReadResponseCreatedByOrganizationDisplayNameMax)
            .optional(),
          is_new: zod.boolean().optional(),
          ws_enabled: zod.boolean().optional(),
          region: zod
            .string()
            .min(1)
            .max(tracerDashboardReadResponseCreatedByOrganizationRegionMax)
            .optional(),
          require_2fa: zod.boolean().optional(),
          require_2fa_grace_period_days: zod
            .number()
            .min(
              tracerDashboardReadResponseCreatedByOrganizationRequire2faGracePeriodDaysMin,
            )
            .max(
              tracerDashboardReadResponseCreatedByOrganizationRequire2faGracePeriodDaysMax,
            )
            .optional(),
          require_2fa_enforced_at: zod
            .string()
      ...
      role: zod
        .string()
        .max(tracerDashboardReadResponseCreatedByRoleMax)
        .optional()
        .describe(
          "User's job role (e.g., Data Scientist, ML Engineer, or custom role)",
        ),
  ...
  updated_by: zod
    .object({
      ...
      email: zod
        ...
        .email()
        .min(1)
        .max(tracerDashboardReadResponseUpdatedByEmailMax),
      name: zod
        .string()
        .min(1)
        .max(tracerDashboardReadResponseUpdatedByNameMax),
      organization_role: zod
        .enum([
          "Owner",
          "Admin",
      ...
      organization: zod
        .object({
          ...
          name: zod
            .string()
            .min(1)
            .max(tracerDashboardReadResponseUpdatedByOrganizationNameMax),
          display_name: zod
            .string()
            .max(tracerDashboardReadResponseUpdatedByOrganizationDisplayNameMax)
            .optional(),
          is_new: zod.boolean().optional(),
          ws_enabled: zod.boolean().optional(),
          region: zod
            .string()
            .min(1)
            .max(tracerDashboardReadResponseUpdatedByOrganizationRegionMax)
            .optional(),
          require_2fa: zod.boolean().optional(),
          require_2fa_grace_period_days: zod
            .number()
            .min(
              tracerDashboardReadResponseUpdatedByOrganizationRequire2faGracePeriodDaysMin,
            )
            .max(
              tracerDashboardReadResponseUpdatedByOrganizationRequire2faGracePeriodDaysMax,
            )
            .optional(),
          require_2fa_enforced_at: zod
            .string()
      ...
      role: zod
        .string()
        .max(tracerDashboardReadResponseUpdatedByRoleMax)
        .optional()
        .describe(
          "User's job role (e.g., Data Scientist, ML Engineer, or custom role)",
        ),
...
export const tracerObservationSpanListResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanListResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanListResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanListResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanListResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanListResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanListResponseResultsItemTotalTokensMin =
  -2147483648;
...
export const TracerObservationSpanListResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      parent_span_id: zod
        .string()
        .max(tracerObservationSpanListResponseResultsItemParentSpanIdMax)
        .optional(),
      name: zod
        .string()
        .min(1)
        .max(tracerObservationSpanListResponseResultsItemNameMax),
      ...
      model: zod
        .string()
        .max(tracerObservationSpanListResponseResultsItemModelMax)
        .optional(),
      model_parameters: zod.object({}).passthrough().optional(),
      latency_ms: zod
        .number()
        .min(tracerObservationSpanListResponseResultsItemLatencyMsMin)
        .max(tracerObservationSpanListResponseResultsItemLatencyMsMax)
        .optional(),
      org_id: zod.string().uuid().optional(),
      org_user_id: zod.string().uuid().optional(),
      prompt_tokens: zod
        .number()
        .min(tracerObservationSpanListResponseResultsItemPromptTokensMin)
        .max(tracerObservationSpanListResponseResultsItemPromptTokensMax)
        .optional(),
      completion_tokens: zod
        .number()
        .min(tracerObservationSpanListResponseResultsItemCompletionTokensMin)
        .max(tracerObservationSpanListResponseResultsItemCompletionTokensMax)
        .optional(),
      total_tokens: zod
        .number()
        .min(tracerObservationSpanListResponseResultsItemTotalTokensMin)
        .max(tracerObservationSpanListResponseResultsItemTotalTokensMax)
        .optional(),
      response_time: zod.number().optional(),
      eval_id: zod
        .string()
        .max(tracerObservationSpanListResponseResultsItemEvalIdMax)
        .optional(),
      ...
      provider: zod
        .string()
        .max(tracerObservationSpanListResponseResultsItemProviderMax)
        .optional(),
...
export const TracerObservationSpanCreateBody = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanCreateBodyParentSpanIdMax)
    .optional(),
  ...
  latency_ms: zod
    .number()
    .min(tracerObservationSpanCreateBodyLatencyMsMin)
    .max(tracerObservationSpanCreateBodyLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanCreateBodyPromptTokensMin)
    .max(tracerObservationSpanCreateBodyPromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanCreateBodyCompletionTokensMin)
    .max(tracerObservationSpanCreateBodyCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanCreateBodyTotalTokensMin)
    .max(tracerObservationSpanCreateBodyTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanCreateBodyEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanCreateBodyProviderMax)
    .optional(),
  custom_eval_config: zod.string().uuid().optional(),
  eval_status: zod
    .enum([
...
export const TracerObservationSpanAddAnnotationsBody = zod.object({
  ...
  annotation_values: zod.record(zod.string(), zod.object({}).passthrough()),
  notes: zod.string().optional(),
});
...
export const tracerObservationSpanBulkCreateBodyCompletionTokensMin =
  -2147483648;
...
export const TracerObservationSpanBulkCreateBody = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanBulkCreateBodyParentSpanIdMax)
    .optional(),
  ...
  model: zod
    .string()
    .max(tracerObservationSpanBulkCreateBodyModelMax)
    .optional(),
  model_parameters: zod.object({}).passthrough().optional(),
  latency_ms: zod
    .number()
    .min(tracerObservationSpanBulkCreateBodyLatencyMsMin)
    .max(tracerObservationSpanBulkCreateBodyLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanBulkCreateBodyPromptTokensMin)
    .max(tracerObservationSpanBulkCreateBodyPromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanBulkCreateBodyCompletionTokensMin)
    .max(tracerObservationSpanBulkCreateBodyCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanBulkCreateBodyTotalTokensMin)
    .max(tracerObservationSpanBulkCreateBodyTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanBulkCreateBodyEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanBulkCreateBodyProviderMax)
    .optional(),
  custom_eval_config: zod.string().uuid().optional(),
  eval_status: zod
    .enum([
...
export const tracerObservationSpanCreateOtelSpanBodyPromptTokensMin =
  -2147483648;
export const tracerObservationSpanCreateOtelSpanBodyPromptTokensMax = 2147483647;

export const tracerObservationSpanCreateOtelSpanBodyCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanCreateOtelSpanBodyCompletionTokensMax = 2147483647;

export const tracerObservationSpanCreateOtelSpanBodyTotalTokensMin =
  -2147483648;
...
export const TracerObservationSpanCreateOtelSpanBody = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanCreateOtelSpanBodyParentSpanIdMax)
    .optional(),
  ...
  model: zod
    .string()
    .max(tracerObservationSpanCreateOtelSpanBodyModelMax)
    .optional(),
  model_parameters: zod.object({}).passthrough().optional(),
  latency_ms: zod
    .number()
    .min(tracerObservationSpanCreateOtelSpanBodyLatencyMsMin)
    .max(tracerObservationSpanCreateOtelSpanBodyLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanCreateOtelSpanBodyPromptTokensMin)
    .max(tracerObservationSpanCreateOtelSpanBodyPromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanCreateOtelSpanBodyCompletionTokensMin)
    .max(tracerObservationSpanCreateOtelSpanBodyCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanCreateOtelSpanBodyTotalTokensMin)
    .max(tracerObservationSpanCreateOtelSpanBodyTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanCreateOtelSpanBodyEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanCreateOtelSpanBodyProviderMax)
    .optional(),
  custom_eval_config: zod.string().uuid().optional(),
  eval_status: zod
    .enum([
...
export const tracerObservationSpanGetEvalAttributesListResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanGetEvalAttributesListResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanGetEvalAttributesListResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanGetEvalAttributesListResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanGetEvalAttributesListResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanGetEvalAttributesListResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanGetEvalAttributesListResponseResultsItemTotalTokensMin =
  -2147483648;
  ...
  results: zod.array(
    zod.object({
      ...
      parent_span_id: zod
        .string()
        .max(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemParentSpanIdMax,
        )
        .optional(),
      name: zod
        .string()
        .min(1)
        .max(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemNameMax,
        ),
      observation_type: zod.enum([
        "tool",
        "chain",
      ...
      model: zod
        .string()
        .max(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemModelMax,
        )
        .optional(),
      model_parameters: zod.object({}).passthrough().optional(),
      latency_ms: zod
        .number()
        .min(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemLatencyMsMin,
        )
        .max(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemLatencyMsMax,
        )
        .optional(),
      org_id: zod.string().uuid().optional(),
      org_user_id: zod.string().uuid().optional(),
      prompt_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemPromptTokensMin,
        )
        .max(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemPromptTokensMax,
        )
        .optional(),
      completion_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemCompletionTokensMin,
        )
        .max(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemCompletionTokensMax,
        )
        .optional(),
      total_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemTotalTokensMin,
        )
        .max(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemTotalTokensMax,
        )
        .optional(),
      response_time: zod.number().optional(),
      eval_id: zod
        .string()
        .max(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemEvalIdMax,
        )
        .optional(),
      cost: zod.number().optional(),
      status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
      ...
      provider: zod
        .string()
        .max(
          tracerObservationSpanGetEvalAttributesListResponseResultsItemProviderMax,
        )
        .optional(),
      provider_logo: zod.string().optional(),
      span_attributes: zod.string().optional(),
...
export const tracerObservationSpanGetEvaluationDetailsResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanGetEvaluationDetailsResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanGetEvaluationDetailsResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanGetEvaluationDetailsResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanGetEvaluationDetailsResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanGetEvaluationDetailsResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanGetEvaluationDetailsResponseResultsItemTotalTokensMin =
  -2147483648;
  ...
  results: zod.array(
    zod.object({
      ...
      parent_span_id: zod
        .string()
        .max(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemParentSpanIdMax,
        )
        .optional(),
      name: zod
        .string()
        .min(1)
        .max(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemNameMax,
        ),
      observation_type: zod.enum([
        "tool",
        "chain",
      ...
      model: zod
        .string()
        .max(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemModelMax,
        )
        .optional(),
      model_parameters: zod.object({}).passthrough().optional(),
      latency_ms: zod
        .number()
        .min(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemLatencyMsMin,
        )
        .max(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemLatencyMsMax,
        )
        .optional(),
      org_id: zod.string().uuid().optional(),
      org_user_id: zod.string().uuid().optional(),
      prompt_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemPromptTokensMin,
        )
        .max(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemPromptTokensMax,
        )
        .optional(),
      completion_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemCompletionTokensMin,
        )
        .max(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemCompletionTokensMax,
        )
        .optional(),
      total_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemTotalTokensMin,
        )
        .max(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemTotalTokensMax,
        )
        .optional(),
      response_time: zod.number().optional(),
      eval_id: zod
        .string()
        .max(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemEvalIdMax,
        )
        .optional(),
      cost: zod.number().optional(),
      status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
      ...
      provider: zod
        .string()
        .max(
          tracerObservationSpanGetEvaluationDetailsResponseResultsItemProviderMax,
        )
        .optional(),
      provider_logo: zod.string().optional(),
      span_attributes: zod.string().optional(),
...
export const tracerObservationSpanGetGraphMethodsBodyPromptTokensMin =
  -2147483648;
export const tracerObservationSpanGetGraphMethodsBodyPromptTokensMax = 2147483647;

export const tracerObservationSpanGetGraphMethodsBodyCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanGetGraphMethodsBodyCompletionTokensMax = 2147483647;

export const tracerObservationSpanGetGraphMethodsBodyTotalTokensMin =
  -2147483648;
...
export const TracerObservationSpanGetGraphMethodsBody = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanGetGraphMethodsBodyParentSpanIdMax)
    .optional(),
  name: zod
    .string()
    .min(1)
    .max(tracerObservationSpanGetGraphMethodsBodyNameMax),
  observation_type: zod.enum([
    "tool",
    "chain",
    "llm",
  ...
  model: zod
    .string()
    .max(tracerObservationSpanGetGraphMethodsBodyModelMax)
    .optional(),
  model_parameters: zod.object({}).passthrough().optional(),
  latency_ms: zod
    .number()
    .min(tracerObservationSpanGetGraphMethodsBodyLatencyMsMin)
    .max(tracerObservationSpanGetGraphMethodsBodyLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanGetGraphMethodsBodyPromptTokensMin)
    .max(tracerObservationSpanGetGraphMethodsBodyPromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanGetGraphMethodsBodyCompletionTokensMin)
    .max(tracerObservationSpanGetGraphMethodsBodyCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanGetGraphMethodsBodyTotalTokensMin)
    .max(tracerObservationSpanGetGraphMethodsBodyTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanGetGraphMethodsBodyEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanGetGraphMethodsBodyProviderMax)
    .optional(),
  custom_eval_config: zod.string().uuid().optional(),
  eval_status: zod
    .enum([
...
export const TracerObservationSpanGetObservationSpanFieldsQueryParams =
  zod.object({
    page: zod
      .number()
      .optional()
...
export const tracerObservationSpanGetObservationSpanFieldsResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanGetObservationSpanFieldsResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanGetObservationSpanFieldsResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanGetObservationSpanFieldsResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanGetObservationSpanFieldsResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanGetObservationSpanFieldsResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanGetObservationSpanFieldsResponseResultsItemTotalTokensMin =
  -2147483648;
    ...
    results: zod.array(
      zod.object({
        ...
        parent_span_id: zod
          .string()
          .max(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemParentSpanIdMax,
          )
          .optional(),
        name: zod
          .string()
          .min(1)
          .max(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemNameMax,
          ),
        observation_type: zod.enum([
          "tool",
          "chain",
        ...
        model: zod
          .string()
          .max(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemModelMax,
          )
          .optional(),
        model_parameters: zod.object({}).passthrough().optional(),
        latency_ms: zod
          .number()
          .min(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemLatencyMsMin,
          )
          .max(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemLatencyMsMax,
          )
          .optional(),
        org_id: zod.string().uuid().optional(),
        org_user_id: zod.string().uuid().optional(),
        prompt_tokens: zod
          .number()
          .min(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemPromptTokensMin,
          )
          .max(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemPromptTokensMax,
          )
          .optional(),
        completion_tokens: zod
          .number()
          .min(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemCompletionTokensMin,
          )
          .max(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemCompletionTokensMax,
          )
          .optional(),
        total_tokens: zod
          .number()
          .min(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemTotalTokensMin,
          )
          .max(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemTotalTokensMax,
          )
          .optional(),
        response_time: zod.number().optional(),
        eval_id: zod
          .string()
          .max(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemEvalIdMax,
          )
          .optional(),
        cost: zod.number().optional(),
        status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
        ...
        provider: zod
          .string()
          .max(
            tracerObservationSpanGetObservationSpanFieldsResponseResultsItemProviderMax,
          )
          .optional(),
        provider_logo: zod.string().optional(),
        span_attributes: zod.string().optional(),
...
export const tracerObservationSpanGetSpanAttributesListResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanGetSpanAttributesListResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanGetSpanAttributesListResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanGetSpanAttributesListResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanGetSpanAttributesListResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanGetSpanAttributesListResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanGetSpanAttributesListResponseResultsItemTotalTokensMin =
  -2147483648;
  ...
  results: zod.array(
    zod.object({
      ...
      parent_span_id: zod
        .string()
        .max(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemParentSpanIdMax,
        )
        .optional(),
      name: zod
        .string()
        .min(1)
        .max(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemNameMax,
        ),
      observation_type: zod.enum([
        "tool",
        "chain",
      ...
      model: zod
        .string()
        .max(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemModelMax,
        )
        .optional(),
      model_parameters: zod.object({}).passthrough().optional(),
      latency_ms: zod
        .number()
        .min(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemLatencyMsMin,
        )
        .max(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemLatencyMsMax,
        )
        .optional(),
      org_id: zod.string().uuid().optional(),
      org_user_id: zod.string().uuid().optional(),
      prompt_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemPromptTokensMin,
        )
        .max(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemPromptTokensMax,
        )
        .optional(),
      completion_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemCompletionTokensMin,
        )
        .max(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemCompletionTokensMax,
        )
        .optional(),
      total_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemTotalTokensMin,
        )
        .max(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemTotalTokensMax,
        )
        .optional(),
      response_time: zod.number().optional(),
      eval_id: zod
        .string()
        .max(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemEvalIdMax,
        )
        .optional(),
      cost: zod.number().optional(),
      status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
      ...
      provider: zod
        .string()
        .max(
          tracerObservationSpanGetSpanAttributesListResponseResultsItemProviderMax,
        )
        .optional(),
      provider_logo: zod.string().optional(),
      span_attributes: zod.string().optional(),
...
export const tracerObservationSpanGetSpansExportDataResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanGetSpansExportDataResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanGetSpansExportDataResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanGetSpansExportDataResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanGetSpansExportDataResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanGetSpansExportDataResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanGetSpansExportDataResponseResultsItemTotalTokensMin =
  -2147483648;
  ...
  results: zod.array(
    zod.object({
      ...
      parent_span_id: zod
        .string()
        .max(
          tracerObservationSpanGetSpansExportDataResponseResultsItemParentSpanIdMax,
        )
        .optional(),
      name: zod
        .string()
        .min(1)
        .max(tracerObservationSpanGetSpansExportDataResponseResultsItemNameMax),
      observation_type: zod.enum([
        "tool",
        "chain",
        "llm",
      ...
      model: zod
        .string()
        .max(tracerObservationSpanGetSpansExportDataResponseResultsItemModelMax)
        .optional(),
      model_parameters: zod.object({}).passthrough().optional(),
      latency_ms: zod
        .number()
        .min(
          tracerObservationSpanGetSpansExportDataResponseResultsItemLatencyMsMin,
        )
        .max(
          tracerObservationSpanGetSpansExportDataResponseResultsItemLatencyMsMax,
        )
        .optional(),
      org_id: zod.string().uuid().optional(),
      org_user_id: zod.string().uuid().optional(),
      prompt_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetSpansExportDataResponseResultsItemPromptTokensMin,
        )
        .max(
          tracerObservationSpanGetSpansExportDataResponseResultsItemPromptTokensMax,
        )
        .optional(),
      completion_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetSpansExportDataResponseResultsItemCompletionTokensMin,
        )
        .max(
          tracerObservationSpanGetSpansExportDataResponseResultsItemCompletionTokensMax,
        )
        .optional(),
      total_tokens: zod
        .number()
        .min(
          tracerObservationSpanGetSpansExportDataResponseResultsItemTotalTokensMin,
        )
        .max(
          tracerObservationSpanGetSpansExportDataResponseResultsItemTotalTokensMax,
        )
        .optional(),
      response_time: zod.number().optional(),
      eval_id: zod
        .string()
        .max(
          tracerObservationSpanGetSpansExportDataResponseResultsItemEvalIdMax,
        )
        .optional(),
      cost: zod.number().optional(),
      status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
      ...
      provider: zod
        .string()
        .max(
          tracerObservationSpanGetSpansExportDataResponseResultsItemProviderMax,
        )
        .optional(),
      provider_logo: zod.string().optional(),
      span_attributes: zod.string().optional(),
 ...
 */
export const TracerObservationSpanGetTraceIdByIndexSpansAsBaseQueryParams =
  zod.object({
    page: zod
      .number()
      .optional()
 ...
 */
export const TracerObservationSpanGetTraceIdByIndexSpansAsObserveQueryParams =
  zod.object({
    page: zod
      .number()
      .optional()
...
export const tracerObservationSpanListSpansResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanListSpansResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanListSpansResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanListSpansResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanListSpansResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanListSpansResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanListSpansResponseResultsItemTotalTokensMin =
  -2147483648;
...
export const TracerObservationSpanListSpansResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      parent_span_id: zod
        .string()
        .max(tracerObservationSpanListSpansResponseResultsItemParentSpanIdMax)
        .optional(),
      name: zod
        .string()
        .min(1)
        .max(tracerObservationSpanListSpansResponseResultsItemNameMax),
      observation_type: zod.enum([
        "tool",
        "chain",
        "llm",
      ...
      model: zod
        .string()
        .max(tracerObservationSpanListSpansResponseResultsItemModelMax)
        .optional(),
      model_parameters: zod.object({}).passthrough().optional(),
      latency_ms: zod
        .number()
        .min(tracerObservationSpanListSpansResponseResultsItemLatencyMsMin)
        .max(tracerObservationSpanListSpansResponseResultsItemLatencyMsMax)
        .optional(),
      org_id: zod.string().uuid().optional(),
      org_user_id: zod.string().uuid().optional(),
      prompt_tokens: zod
        .number()
        .min(tracerObservationSpanListSpansResponseResultsItemPromptTokensMin)
        .max(tracerObservationSpanListSpansResponseResultsItemPromptTokensMax)
        .optional(),
      completion_tokens: zod
        .number()
        .min(
          tracerObservationSpanListSpansResponseResultsItemCompletionTokensMin,
        )
        .max(
          tracerObservationSpanListSpansResponseResultsItemCompletionTokensMax,
        )
        .optional(),
      total_tokens: zod
        .number()
        .min(tracerObservationSpanListSpansResponseResultsItemTotalTokensMin)
        .max(tracerObservationSpanListSpansResponseResultsItemTotalTokensMax)
        .optional(),
      response_time: zod.number().optional(),
      eval_id: zod
        .string()
        .max(tracerObservationSpanListSpansResponseResultsItemEvalIdMax)
        .optional(),
      cost: zod.number().optional(),
      status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
      status_message: zod.string().optional(),
      ...
      provider: zod
        .string()
        .max(tracerObservationSpanListSpansResponseResultsItemProviderMax)
        .optional(),
      provider_logo: zod.string().optional(),
      span_attributes: zod.string().optional(),
      custom_eval_config: zod.string().uuid().optional(),
...
export const tracerObservationSpanListSpansObserveResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanListSpansObserveResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanListSpansObserveResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanListSpansObserveResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanListSpansObserveResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanListSpansObserveResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanListSpansObserveResponseResultsItemTotalTokensMin =
  -2147483648;
  ...
  results: zod.array(
    zod.object({
      ...
      parent_span_id: zod
        .string()
        .max(
          tracerObservationSpanListSpansObserveResponseResultsItemParentSpanIdMax,
        )
        .optional(),
      name: zod
        .string()
        .min(1)
        .max(tracerObservationSpanListSpansObserveResponseResultsItemNameMax),
      observation_type: zod.enum([
        "tool",
        "chain",
        "llm",
      ...
      model: zod
        .string()
        .max(tracerObservationSpanListSpansObserveResponseResultsItemModelMax)
        .optional(),
      model_parameters: zod.object({}).passthrough().optional(),
      latency_ms: zod
        .number()
        .min(
          tracerObservationSpanListSpansObserveResponseResultsItemLatencyMsMin,
        )
        .max(
          tracerObservationSpanListSpansObserveResponseResultsItemLatencyMsMax,
        )
        .optional(),
      org_id: zod.string().uuid().optional(),
      org_user_id: zod.string().uuid().optional(),
      prompt_tokens: zod
        .number()
        .min(
          tracerObservationSpanListSpansObserveResponseResultsItemPromptTokensMin,
        )
        .max(
          tracerObservationSpanListSpansObserveResponseResultsItemPromptTokensMax,
        )
        .optional(),
      completion_tokens: zod
        .number()
        .min(
          tracerObservationSpanListSpansObserveResponseResultsItemCompletionTokensMin,
        )
        .max(
          tracerObservationSpanListSpansObserveResponseResultsItemCompletionTokensMax,
        )
        .optional(),
      total_tokens: zod
        .number()
        .min(
          tracerObservationSpanListSpansObserveResponseResultsItemTotalTokensMin,
        )
        .max(
          tracerObservationSpanListSpansObserveResponseResultsItemTotalTokensMax,
        )
        .optional(),
      response_time: zod.number().optional(),
      eval_id: zod
        .string()
        .max(tracerObservationSpanListSpansObserveResponseResultsItemEvalIdMax)
        .optional(),
      cost: zod.number().optional(),
      status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
      status_message: zod.string().optional(),
      ...
      provider: zod
        .string()
        .max(
          tracerObservationSpanListSpansObserveResponseResultsItemProviderMax,
        )
        .optional(),
      provider_logo: zod.string().optional(),
      span_attributes: zod.string().optional(),
...
export const tracerObservationSpanRetrieveLoadingResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanRetrieveLoadingResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanRetrieveLoadingResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanRetrieveLoadingResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanRetrieveLoadingResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanRetrieveLoadingResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanRetrieveLoadingResponseResultsItemTotalTokensMin =
  -2147483648;
  ...
  results: zod.array(
    zod.object({
      ...
      parent_span_id: zod
        .string()
        .max(
          tracerObservationSpanRetrieveLoadingResponseResultsItemParentSpanIdMax,
        )
        .optional(),
      name: zod
        .string()
        .min(1)
        .max(tracerObservationSpanRetrieveLoadingResponseResultsItemNameMax),
      observation_type: zod.enum([
        "tool",
        "chain",
        "llm",
      ...
      model: zod
        .string()
        .max(tracerObservationSpanRetrieveLoadingResponseResultsItemModelMax)
        .optional(),
      model_parameters: zod.object({}).passthrough().optional(),
      latency_ms: zod
        .number()
        .min(
          tracerObservationSpanRetrieveLoadingResponseResultsItemLatencyMsMin,
        )
        .max(
          tracerObservationSpanRetrieveLoadingResponseResultsItemLatencyMsMax,
        )
        .optional(),
      org_id: zod.string().uuid().optional(),
      org_user_id: zod.string().uuid().optional(),
      prompt_tokens: zod
        .number()
        .min(
          tracerObservationSpanRetrieveLoadingResponseResultsItemPromptTokensMin,
        )
        .max(
          tracerObservationSpanRetrieveLoadingResponseResultsItemPromptTokensMax,
        )
        .optional(),
      completion_tokens: zod
        .number()
        .min(
          tracerObservationSpanRetrieveLoadingResponseResultsItemCompletionTokensMin,
        )
        .max(
          tracerObservationSpanRetrieveLoadingResponseResultsItemCompletionTokensMax,
        )
        .optional(),
      total_tokens: zod
        .number()
        .min(
          tracerObservationSpanRetrieveLoadingResponseResultsItemTotalTokensMin,
        )
        .max(
          tracerObservationSpanRetrieveLoadingResponseResultsItemTotalTokensMax,
        )
        .optional(),
      response_time: zod.number().optional(),
      eval_id: zod
        .string()
        .max(tracerObservationSpanRetrieveLoadingResponseResultsItemEvalIdMax)
        .optional(),
      cost: zod.number().optional(),
      status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
      status_message: zod.string().optional(),
      ...
      provider: zod
        .string()
        .max(tracerObservationSpanRetrieveLoadingResponseResultsItemProviderMax)
        .optional(),
      provider_logo: zod.string().optional(),
      span_attributes: zod.string().optional(),
      custom_eval_config: zod.string().uuid().optional(),
...
export const tracerObservationSpanRootSpansResponseResultsItemLatencyMsMin =
  -2147483648;
export const tracerObservationSpanRootSpansResponseResultsItemLatencyMsMax = 2147483647;

export const tracerObservationSpanRootSpansResponseResultsItemPromptTokensMin =
  -2147483648;
export const tracerObservationSpanRootSpansResponseResultsItemPromptTokensMax = 2147483647;

export const tracerObservationSpanRootSpansResponseResultsItemCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanRootSpansResponseResultsItemCompletionTokensMax = 2147483647;

export const tracerObservationSpanRootSpansResponseResultsItemTotalTokensMin =
  -2147483648;
...
export const TracerObservationSpanRootSpansResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      parent_span_id: zod
        .string()
        .max(tracerObservationSpanRootSpansResponseResultsItemParentSpanIdMax)
        .optional(),
      name: zod
        .string()
        .min(1)
        .max(tracerObservationSpanRootSpansResponseResultsItemNameMax),
      observation_type: zod.enum([
        "tool",
        "chain",
        "llm",
      ...
      model: zod
        .string()
        .max(tracerObservationSpanRootSpansResponseResultsItemModelMax)
        .optional(),
      model_parameters: zod.object({}).passthrough().optional(),
      latency_ms: zod
        .number()
        .min(tracerObservationSpanRootSpansResponseResultsItemLatencyMsMin)
        .max(tracerObservationSpanRootSpansResponseResultsItemLatencyMsMax)
        .optional(),
      org_id: zod.string().uuid().optional(),
      org_user_id: zod.string().uuid().optional(),
      prompt_tokens: zod
        .number()
        .min(tracerObservationSpanRootSpansResponseResultsItemPromptTokensMin)
        .max(tracerObservationSpanRootSpansResponseResultsItemPromptTokensMax)
        .optional(),
      completion_tokens: zod
        .number()
        .min(
          tracerObservationSpanRootSpansResponseResultsItemCompletionTokensMin,
        )
        .max(
          tracerObservationSpanRootSpansResponseResultsItemCompletionTokensMax,
        )
        .optional(),
      total_tokens: zod
        .number()
        .min(tracerObservationSpanRootSpansResponseResultsItemTotalTokensMin)
        .max(tracerObservationSpanRootSpansResponseResultsItemTotalTokensMax)
        .optional(),
      response_time: zod.number().optional(),
      eval_id: zod
        .string()
        .max(tracerObservationSpanRootSpansResponseResultsItemEvalIdMax)
        .optional(),
      cost: zod.number().optional(),
      status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
      status_message: zod.string().optional(),
      ...
      provider: zod
        .string()
        .max(tracerObservationSpanRootSpansResponseResultsItemProviderMax)
        .optional(),
      provider_logo: zod.string().optional(),
      span_attributes: zod.string().optional(),
      custom_eval_config: zod.string().uuid().optional(),
...
export const tracerObservationSpanSubmitFeedbackBodyPromptTokensMin =
  -2147483648;
export const tracerObservationSpanSubmitFeedbackBodyPromptTokensMax = 2147483647;

export const tracerObservationSpanSubmitFeedbackBodyCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanSubmitFeedbackBodyCompletionTokensMax = 2147483647;

export const tracerObservationSpanSubmitFeedbackBodyTotalTokensMin =
  -2147483648;
...
export const TracerObservationSpanSubmitFeedbackBody = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanSubmitFeedbackBodyParentSpanIdMax)
    .optional(),
  ...
  model: zod
    .string()
    .max(tracerObservationSpanSubmitFeedbackBodyModelMax)
    .optional(),
  model_parameters: zod.object({}).passthrough().optional(),
  latency_ms: zod
    .number()
    .min(tracerObservationSpanSubmitFeedbackBodyLatencyMsMin)
    .max(tracerObservationSpanSubmitFeedbackBodyLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanSubmitFeedbackBodyPromptTokensMin)
    .max(tracerObservationSpanSubmitFeedbackBodyPromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanSubmitFeedbackBodyCompletionTokensMin)
    .max(tracerObservationSpanSubmitFeedbackBodyCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanSubmitFeedbackBodyTotalTokensMin)
    .max(tracerObservationSpanSubmitFeedbackBodyTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanSubmitFeedbackBodyEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanSubmitFeedbackBodyProviderMax)
    .optional(),
  custom_eval_config: zod.string().uuid().optional(),
  eval_status: zod
    .enum([
...
export const tracerObservationSpanSubmitFeedbackActionTypeBodyLatencyMsMin =
  -2147483648;
export const tracerObservationSpanSubmitFeedbackActionTypeBodyLatencyMsMax = 2147483647;

export const tracerObservationSpanSubmitFeedbackActionTypeBodyPromptTokensMin =
  -2147483648;
export const tracerObservationSpanSubmitFeedbackActionTypeBodyPromptTokensMax = 2147483647;

export const tracerObservationSpanSubmitFeedbackActionTypeBodyCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanSubmitFeedbackActionTypeBodyCompletionTokensMax = 2147483647;

export const tracerObservationSpanSubmitFeedbackActionTypeBodyTotalTokensMin =
  -2147483648;
...
export const TracerObservationSpanSubmitFeedbackActionTypeBody = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanSubmitFeedbackActionTypeBodyParentSpanIdMax)
    .optional(),
  name: zod
    .string()
    .min(1)
    .max(tracerObservationSpanSubmitFeedbackActionTypeBodyNameMax),
  observation_type: zod.enum([
    "tool",
    "chain",
    "llm",
  ...
  model: zod
    .string()
    .max(tracerObservationSpanSubmitFeedbackActionTypeBodyModelMax)
    .optional(),
  model_parameters: zod.object({}).passthrough().optional(),
  latency_ms: zod
    .number()
    .min(tracerObservationSpanSubmitFeedbackActionTypeBodyLatencyMsMin)
    .max(tracerObservationSpanSubmitFeedbackActionTypeBodyLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanSubmitFeedbackActionTypeBodyPromptTokensMin)
    .max(tracerObservationSpanSubmitFeedbackActionTypeBodyPromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanSubmitFeedbackActionTypeBodyCompletionTokensMin)
    .max(tracerObservationSpanSubmitFeedbackActionTypeBodyCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanSubmitFeedbackActionTypeBodyTotalTokensMin)
    .max(tracerObservationSpanSubmitFeedbackActionTypeBodyTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanSubmitFeedbackActionTypeBodyEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanSubmitFeedbackActionTypeBodyProviderMax)
    .optional(),
  custom_eval_config: zod.string().uuid().optional(),
  eval_status: zod
    .enum([
...
export const tracerObservationSpanUpdateTagsBodyCompletionTokensMin =
  -2147483648;
...
export const TracerObservationSpanUpdateTagsBody = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanUpdateTagsBodyParentSpanIdMax)
    .optional(),
  ...
  model: zod
    .string()
    .max(tracerObservationSpanUpdateTagsBodyModelMax)
    .optional(),
  model_parameters: zod.object({}).passthrough().optional(),
  latency_ms: zod
    .number()
    .min(tracerObservationSpanUpdateTagsBodyLatencyMsMin)
    .max(tracerObservationSpanUpdateTagsBodyLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanUpdateTagsBodyPromptTokensMin)
    .max(tracerObservationSpanUpdateTagsBodyPromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanUpdateTagsBodyCompletionTokensMin)
    .max(tracerObservationSpanUpdateTagsBodyCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanUpdateTagsBodyTotalTokensMin)
    .max(tracerObservationSpanUpdateTagsBodyTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanUpdateTagsBodyEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanUpdateTagsBodyProviderMax)
    .optional(),
  custom_eval_config: zod.string().uuid().optional(),
  eval_status: zod
    .enum([
...
export const TracerObservationSpanUpdateBody = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanUpdateBodyParentSpanIdMax)
    .optional(),
  ...
  latency_ms: zod
    .number()
    .min(tracerObservationSpanUpdateBodyLatencyMsMin)
    .max(tracerObservationSpanUpdateBodyLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanUpdateBodyPromptTokensMin)
    .max(tracerObservationSpanUpdateBodyPromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanUpdateBodyCompletionTokensMin)
    .max(tracerObservationSpanUpdateBodyCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanUpdateBodyTotalTokensMin)
    .max(tracerObservationSpanUpdateBodyTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanUpdateBodyEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanUpdateBodyProviderMax)
    .optional(),
  custom_eval_config: zod.string().uuid().optional(),
  eval_status: zod
    .enum([
...
export const tracerObservationSpanUpdateResponseCompletionTokensMin =
  -2147483648;
...
export const TracerObservationSpanUpdateResponse = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanUpdateResponseParentSpanIdMax)
    .optional(),
  ...
  model: zod
    .string()
    .max(tracerObservationSpanUpdateResponseModelMax)
    .optional(),
  model_parameters: zod.object({}).passthrough().optional(),
  latency_ms: zod
    .number()
    .min(tracerObservationSpanUpdateResponseLatencyMsMin)
    .max(tracerObservationSpanUpdateResponseLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanUpdateResponsePromptTokensMin)
    .max(tracerObservationSpanUpdateResponsePromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanUpdateResponseCompletionTokensMin)
    .max(tracerObservationSpanUpdateResponseCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanUpdateResponseTotalTokensMin)
    .max(tracerObservationSpanUpdateResponseTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanUpdateResponseEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanUpdateResponseProviderMax)
    .optional(),
  provider_logo: zod.string().optional(),
  span_attributes: zod.string().optional(),
  custom_eval_config: zod.string().uuid().optional(),
...
export const tracerObservationSpanPartialUpdateBodyPromptTokensMin =
  -2147483648;
export const tracerObservationSpanPartialUpdateBodyPromptTokensMax = 2147483647;

export const tracerObservationSpanPartialUpdateBodyCompletionTokensMin =
  -2147483648;
...
export const TracerObservationSpanPartialUpdateBody = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanPartialUpdateBodyParentSpanIdMax)
    .optional(),
  ...
  model: zod
    .string()
    .max(tracerObservationSpanPartialUpdateBodyModelMax)
    .optional(),
  model_parameters: zod.object({}).passthrough().optional(),
  latency_ms: zod
    .number()
    .min(tracerObservationSpanPartialUpdateBodyLatencyMsMin)
    .max(tracerObservationSpanPartialUpdateBodyLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanPartialUpdateBodyPromptTokensMin)
    .max(tracerObservationSpanPartialUpdateBodyPromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanPartialUpdateBodyCompletionTokensMin)
    .max(tracerObservationSpanPartialUpdateBodyCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanPartialUpdateBodyTotalTokensMin)
    .max(tracerObservationSpanPartialUpdateBodyTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanPartialUpdateBodyEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanPartialUpdateBodyProviderMax)
    .optional(),
  custom_eval_config: zod.string().uuid().optional(),
  eval_status: zod
    .enum([
...
export const tracerObservationSpanPartialUpdateResponseLatencyMsMin =
  -2147483648;
export const tracerObservationSpanPartialUpdateResponseLatencyMsMax = 2147483647;

export const tracerObservationSpanPartialUpdateResponsePromptTokensMin =
  -2147483648;
export const tracerObservationSpanPartialUpdateResponsePromptTokensMax = 2147483647;

export const tracerObservationSpanPartialUpdateResponseCompletionTokensMin =
  -2147483648;
export const tracerObservationSpanPartialUpdateResponseCompletionTokensMax = 2147483647;

export const tracerObservationSpanPartialUpdateResponseTotalTokensMin =
  -2147483648;
...
export const TracerObservationSpanPartialUpdateResponse = zod.object({
  ...
  parent_span_id: zod
    .string()
    .max(tracerObservationSpanPartialUpdateResponseParentSpanIdMax)
    .optional(),
  name: zod
    .string()
    .min(1)
    .max(tracerObservationSpanPartialUpdateResponseNameMax),
  observation_type: zod.enum([
    "tool",
    "chain",
    "llm",
  ...
  model: zod
    .string()
    .max(tracerObservationSpanPartialUpdateResponseModelMax)
    .optional(),
  model_parameters: zod.object({}).passthrough().optional(),
  latency_ms: zod
    .number()
    .min(tracerObservationSpanPartialUpdateResponseLatencyMsMin)
    .max(tracerObservationSpanPartialUpdateResponseLatencyMsMax)
    .optional(),
  org_id: zod.string().uuid().optional(),
  org_user_id: zod.string().uuid().optional(),
  prompt_tokens: zod
    .number()
    .min(tracerObservationSpanPartialUpdateResponsePromptTokensMin)
    .max(tracerObservationSpanPartialUpdateResponsePromptTokensMax)
    .optional(),
  completion_tokens: zod
    .number()
    .min(tracerObservationSpanPartialUpdateResponseCompletionTokensMin)
    .max(tracerObservationSpanPartialUpdateResponseCompletionTokensMax)
    .optional(),
  total_tokens: zod
    .number()
    .min(tracerObservationSpanPartialUpdateResponseTotalTokensMin)
    .max(tracerObservationSpanPartialUpdateResponseTotalTokensMax)
    .optional(),
  response_time: zod.number().optional(),
  eval_id: zod
    .string()
    .max(tracerObservationSpanPartialUpdateResponseEvalIdMax)
    .optional(),
  cost: zod.number().optional(),
  status: zod.enum(["UNSET", "OK", "ERROR"]).optional(),
  status_message: zod.string().optional(),
  ...
  provider: zod
    .string()
    .max(tracerObservationSpanPartialUpdateResponseProviderMax)
    .optional(),
  provider_logo: zod.string().optional(),
  span_attributes: zod.string().optional(),
  custom_eval_config: zod.string().uuid().optional(),
...
export const TracerProjectVersionAddAnnotationsBody = zod.object({
  ...
  eval_tags: zod.object({}).passthrough().optional(),
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(tracerProjectListResponseResultsItemNameMax),
      ...
      session_config: zod.object({}).passthrough().optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
});
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(tracerProjectFetchSystemMetricsResponseResultsItemNameMax),
      trace_type: zod.enum(["experiment", "observe"]),
      metadata: zod.object({}).passthrough().optional(),
      organization: zod.string().uuid().optional(),
      workspace: zod.string().uuid().optional(),
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(tracerProjectGetGraphDataResponseResultsItemNameMax),
      trace_type: zod.enum(["experiment", "observe"]),
      metadata: zod.object({}).passthrough().optional(),
      organization: zod.string().uuid().optional(),
      workspace: zod.string().uuid().optional(),
...
export const TracerProjectGetUsersAggregateGraphDataBody = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(tracerProjectGetUsersAggregateGraphDataBodyNameMax),
  trace_type: zod.enum(["experiment", "observe"]),
  metadata: zod.object({}).passthrough().optional(),
  config: zod.object({}).passthrough().optional(),
  source: zod.enum(["demo", "prototype", "simulator"]).optional(),
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(tracerProjectListProjectIdsResponseResultsItemNameMax),
      trace_type: zod.enum(["experiment", "observe"]),
      metadata: zod.object({}).passthrough().optional(),
      organization: zod.string().uuid().optional(),
      workspace: zod.string().uuid().optional(),
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(tracerProjectListProjectsResponseResultsItemNameMax),
      trace_type: zod.enum(["experiment", "observe"]),
      metadata: zod.object({}).passthrough().optional(),
      organization: zod.string().uuid().optional(),
      workspace: zod.string().uuid().optional(),
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .min(1)
        .max(tracerProjectProjectSdkCodeResponseResultsItemNameMax),
      trace_type: zod.enum(["experiment", "observe"]),
      metadata: zod.object({}).passthrough().optional(),
      organization: zod.string().uuid().optional(),
      workspace: zod.string().uuid().optional(),
...
export const TracerProjectUpdateProjectSessionConfigBody = zod.object({
  ...
  name: zod
    .string()
    .min(1)
    .max(tracerProjectUpdateProjectSessionConfigBodyNameMax),
  trace_type: zod.enum(["experiment", "observe"]),
  metadata: zod.object({}).passthrough().optional(),
  config: zod.object({}).passthrough().optional(),
  source: zod.enum(["demo", "prototype", "simulator"]).optional(),
...
export const TracerTraceAnnotationListResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      observation_span_id: zod
        .string()
        .min(1)
        .max(tracerTraceAnnotationListResponseResultsItemObservationSpanIdMax)
        .optional(),
      trace_id: zod.string().uuid().optional(),
...
export const TracerTraceAnnotationCreateBody = zod.object({
  observation_span_id: zod
    .string()
    .min(1)
    .max(tracerTraceAnnotationCreateBodyObservationSpanIdMax)
    .optional(),
  trace_id: zod.string().uuid().optional(),
  annotators: zod.array(zod.string().uuid()).optional(),
  exclude_annotators: zod.array(zod.string().uuid()).optional(),
  ...
  results: zod.array(
    zod.object({
      observation_span_id: zod
        ...
        .min(1)
        .max(
          tracerTraceAnnotationGetAnnotationValuesResponseResultsItemObservationSpanIdMax,
        )
        .optional(),
      trace_id: zod.string().uuid().optional(),
      annotators: zod.array(zod.string().uuid()).optional(),
...
export const TracerTraceAnnotationReadResponse = zod.object({
  observation_span_id: zod
    .string()
    .min(1)
    .max(tracerTraceAnnotationReadResponseObservationSpanIdMax)
    .optional(),
  trace_id: zod.string().uuid().optional(),
  annotators: zod.array(zod.string().uuid()).optional(),
  exclude_annotators: zod.array(zod.string().uuid()).optional(),
...
export const TracerTraceAnnotationUpdateBody = zod.object({
  observation_span_id: zod
    .string()
    .min(1)
    .max(tracerTraceAnnotationUpdateBodyObservationSpanIdMax)
    .optional(),
  trace_id: zod.string().uuid().optional(),
  annotators: zod.array(zod.string().uuid()).optional(),
  exclude_annotators: zod.array(zod.string().uuid()).optional(),
...
export const TracerTraceAnnotationUpdateResponse = zod.object({
  observation_span_id: zod
    .string()
    .min(1)
    .max(tracerTraceAnnotationUpdateResponseObservationSpanIdMax)
    .optional(),
  trace_id: zod.string().uuid().optional(),
  annotators: zod.array(zod.string().uuid()).optional(),
  exclude_annotators: zod.array(zod.string().uuid()).optional(),
...
export const TracerTraceAnnotationPartialUpdateBody = zod.object({
  observation_span_id: zod
    .string()
    .min(1)
    .max(tracerTraceAnnotationPartialUpdateBodyObservationSpanIdMax)
    .optional(),
  trace_id: zod.string().uuid().optional(),
  annotators: zod.array(zod.string().uuid()).optional(),
  exclude_annotators: zod.array(zod.string().uuid()).optional(),
...
export const TracerTraceAnnotationPartialUpdateResponse = zod.object({
  observation_span_id: zod
    .string()
    .min(1)
    .max(tracerTraceAnnotationPartialUpdateResponseObservationSpanIdMax)
    .optional(),
  trace_id: zod.string().uuid().optional(),
  annotators: zod.array(zod.string().uuid()).optional(),
  exclude_annotators: zod.array(zod.string().uuid()).optional(),
...
export const TracerTraceSessionListResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceSessionListResponseResultsItemNameMax)
        .optional(),
      created_at: zod.string().datetime({ offset: true }).optional(),
    }),
  ),
...
export const TracerTraceSessionGetSessionFilterValuesResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceSessionGetSessionFilterValuesResponseResultsItemNameMax)
        .optional(),
      created_at: zod.string().datetime({ offset: true }).optional(),
    }),
  ),
...
export const TracerTraceSessionGetSessionGraphDataBody = zod.object({
  ...
  name: zod
    .string()
    .max(tracerTraceSessionGetSessionGraphDataBodyNameMax)
    .optional(),
});
 ...
 */
export const TracerTraceSessionGetTraceSessionExportDataQueryParams =
  zod.object({
    page: zod
      .number()
      .optional()
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(
          tracerTraceSessionGetTraceSessionExportDataResponseResultsItemNameMax,
        )
        .optional(),
      created_at: zod.string().datetime({ offset: true }).optional(),
    }),
...
export const TracerTraceSessionListSessionsResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceSessionListSessionsResponseResultsItemNameMax)
        .optional(),
      created_at: zod.string().datetime({ offset: true }).optional(),
    }),
  ),
...
export const TracerTraceSessionPartialUpdateResponse = zod.object({
  ...
  name: zod
    .string()
    .max(tracerTraceSessionPartialUpdateResponseNameMax)
    .optional(),
  created_at: zod.string().datetime({ offset: true }).optional(),
});
...
export const TracerTraceListResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceListResponseResultsItemNameMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      input: zod.object({}).passthrough().optional(),
      output: zod.object({}).passthrough().optional(),
      ...
      external_id: zod
        .string()
        .max(tracerTraceListResponseResultsItemExternalIdMax)
        .optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
...
export const TracerTraceAgentGraphResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceAgentGraphResponseResultsItemNameMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      input: zod.object({}).passthrough().optional(),
      output: zod.object({}).passthrough().optional(),
      ...
      external_id: zod
        .string()
        .max(tracerTraceAgentGraphResponseResultsItemExternalIdMax)
        .optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
...
export const TracerTraceBulkCreateBody = zod.object({
  ...
  external_id: zod
    .string()
    .max(tracerTraceBulkCreateBodyExternalIdMax)
    .optional(),
  tags: zod.object({}).passthrough().optional(),
});
...
export const TracerTraceCompareTracesBody = zod.object({
  ...
  external_id: zod
    .string()
    .max(tracerTraceCompareTracesBodyExternalIdMax)
    .optional(),
  tags: zod.object({}).passthrough().optional(),
});
...
export const TracerTraceGetEvalNamesResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceGetEvalNamesResponseResultsItemNameMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      input: zod.object({}).passthrough().optional(),
      output: zod.object({}).passthrough().optional(),
      ...
      external_id: zod
        .string()
        .max(tracerTraceGetEvalNamesResponseResultsItemExternalIdMax)
        .optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
...
export const TracerTraceGetGraphMethodsBody = zod.object({
  ...
  external_id: zod
    .string()
    .max(tracerTraceGetGraphMethodsBodyExternalIdMax)
    .optional(),
  tags: zod.object({}).passthrough().optional(),
});
...
export const TracerTraceGetPropertiesResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceGetPropertiesResponseResultsItemNameMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      input: zod.object({}).passthrough().optional(),
      output: zod.object({}).passthrough().optional(),
      ...
      external_id: zod
        .string()
        .max(tracerTraceGetPropertiesResponseResultsItemExternalIdMax)
        .optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
...
export const TracerTraceGetTraceExportDataResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceGetTraceExportDataResponseResultsItemNameMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      input: zod.object({}).passthrough().optional(),
      output: zod.object({}).passthrough().optional(),
      ...
      external_id: zod
        .string()
        .max(tracerTraceGetTraceExportDataResponseResultsItemExternalIdMax)
        .optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
...
export const TracerTraceListTracesResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceListTracesResponseResultsItemNameMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      input: zod.object({}).passthrough().optional(),
      output: zod.object({}).passthrough().optional(),
      ...
      external_id: zod
        .string()
        .max(tracerTraceListTracesResponseResultsItemExternalIdMax)
        .optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
...
export const TracerTraceListTracesOfSessionResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceListTracesOfSessionResponseResultsItemNameMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      input: zod.object({}).passthrough().optional(),
      output: zod.object({}).passthrough().optional(),
      ...
      external_id: zod
        .string()
        .max(tracerTraceListTracesOfSessionResponseResultsItemExternalIdMax)
        .optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
...
export const TracerTraceListVoiceCallsResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceListVoiceCallsResponseResultsItemNameMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      input: zod.object({}).passthrough().optional(),
      output: zod.object({}).passthrough().optional(),
      ...
      external_id: zod
        .string()
        .max(tracerTraceListVoiceCallsResponseResultsItemExternalIdMax)
        .optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
...
export const TracerTraceVoiceCallDetailResponse = zod.object({
  ...
  results: zod.array(
    zod.object({
      ...
      name: zod
        .string()
        .max(tracerTraceVoiceCallDetailResponseResultsItemNameMax)
        .optional(),
      metadata: zod.object({}).passthrough().optional(),
      input: zod.object({}).passthrough().optional(),
      output: zod.object({}).passthrough().optional(),
      ...
      external_id: zod
        .string()
        .max(tracerTraceVoiceCallDetailResponseResultsItemExternalIdMax)
        .optional(),
      tags: zod.object({}).passthrough().optional(),
    }),
  ),
...
export const TracerTraceReadResponse = zod.object({
  ...
  external_id: zod
    .string()
    .max(tracerTraceReadResponseExternalIdMax)
    .optional(),
  tags: zod.object({}).passthrough().optional(),
});
...
export const TracerTraceUpdateResponse = zod.object({
  ...
  external_id: zod
    .string()
    .max(tracerTraceUpdateResponseExternalIdMax)
    .optional(),
  tags: zod.object({}).passthrough().optional(),
});
...
export const TracerTracePartialUpdateBody = zod.object({
  ...
  external_id: zod
    .string()
    .max(tracerTracePartialUpdateBodyExternalIdMax)
    .optional(),
  tags: zod.object({}).passthrough().optional(),
});
...
export const TracerTracePartialUpdateResponse = zod.object({
  ...
  external_id: zod
    .string()
    .max(tracerTracePartialUpdateResponseExternalIdMax)
    .optional(),
  tags: zod.object({}).passthrough().optional(),
});
