...
export type SelectionApiFilterItem = { [key: string]: string };
...
export type ModelHubAnnotationQueuesForSource200 = {
  count: number;
  next?: string;
  previous?: string;
  results: AnnotationQueueApi[];
...
export type ModelHubAnnotationQueuesExportAnnotationsFormat =
  (typeof ModelHubAnnotationQueuesExportAnnotationsFormat)[keyof typeof ModelHubAnnotationQueuesExportAnnotationsFormat];
...
export type ModelHubAnnotationQueuesItemsNextItem200 = {
  count: number;
  next?: string;
  previous?: string;
  results: QueueItemApi[];
...
export type ModelHubScoresForSource200 = {
  count: number;
  next?: string;
  previous?: string;
  results: ScoreApi[];
