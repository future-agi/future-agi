...
export type HarnessScenarioPersonaApiMetadata = {
  [key: string]: { [key: string]: unknown };
};
 ...
 * Any valid JSON value.
 */
export type HarnessScenarioPersonaApiScriptedCaller = {
  [key: string]: unknown;
};

export interface HarnessScenarioPersonaApi {
  name?: string;
  gender?: string;
  age_group?: string;
  occupation?: string;
  ...
  metadata?: HarnessScenarioPersonaApiMetadata;
  /** Any valid JSON value. */
  scripted_caller?: HarnessScenarioPersonaApiScriptedCaller;
  keywords?: string[];
}
...
export interface HarnessScenarioRowApi {
  ...
  branch: string;
  tests: string;
  persona: HarnessScenarioPersonaApi;
...
export interface HarnessScenarioGroupApi {
  /** @minLength 1 */
  name: string;
  count: number;
  total?: number;
...
export type HarnessScenarioFieldApiCounts = { [key: string]: number };

export interface HarnessScenarioFieldApi {
  /** @minLength 1 */
  value: string;
  /** @minLength 1 */
  label: string;
  ...
  category: string;
  choices?: string[];
  counts?: HarnessScenarioFieldApiCounts;
}

export type HarnessScenarioEditingApiPersonaChoices = {
  [key: string]: string[];
};

export interface HarnessScenarioEditingApi {
  editable_fields: string[];
  persona_fields: string[];
  persona_choices: HarnessScenarioEditingApiPersonaChoices;
  rework_fields: string[];
}

export interface HarnessScenarioGroupingApi {
  value: string;
  /** @minLength 1 */
  label: string;
}
...
export interface HarnessScenarioListResponseApi {
  ...
  groups: HarnessScenarioGroupApi[];
  group_by: string;
  fields: HarnessScenarioFieldApi[];
  scenario_editing: HarnessScenarioEditingApi;
  groupings: HarnessScenarioGroupingApi[];
...
export type HarnessScenarioReceiptApiOutcome =
  (typeof HarnessScenarioReceiptApiOutcome)[keyof typeof HarnessScenarioReceiptApiOutcome];

export const HarnessScenarioReceiptApiOutcome = {
  applied: "applied",
  queued: "queued",
  refused: "refused",
} as const;

export interface HarnessScenarioReceiptApi {
  scenario: string;
  outcome: HarnessScenarioReceiptApiOutcome;
  why: string;
}

export interface HarnessScenarioAmendResponseApi {
  receipts: HarnessScenarioReceiptApi[];
}
...
export type HarnessCoverageAxisApiCounts = { [key: string]: number };

export interface HarnessCoverageAxisApi {
  /** @minLength 1 */
  axis: string;
  /** @minLength 1 */
  label: string;
  levels: number;
  scenarios: number;
  counts: HarnessCoverageAxisApiCounts;
}

export interface HarnessCoverageCellApi {
  /** @minLength 1 */
  row: string;
  /** @minLength 1 */
  column: string;
...
export interface HarnessScenarioCoverageResponseApi {
  per_axis: HarnessCoverageAxisApi[];
  /** @minLength 1 */
  row_axis: string;
  /** @minLength 1 */
...
export type SimulateApiHarnessJobsScenariosParams = {
  /**
   * @minimum 1
   */
  page?: number;
...
export type SimulateApiHarnessJobsScenariosScenarioCoverageParams = {
  search?: string;
  row_axis?: string;
  col_axis?: string;
};
