# CATALOG property, filter, and list API matrix
...
[`FI_INTERACTIVE_READ_MATRIX.md`](FI_INTERACTIVE_READ_MATRIX.md).
...
> `fi_catalog_dev_kartik_0817j`. Canonical PostgreSQL ownership resolved 90
...
| Catalog source/publisher   | `PROPERTY_CATALOG_SOURCE_ADAPTER_WALL_SECONDS=8.5`; `PROPERTY_CATALOG_SCHEDULED_RECONCILE_SOURCE_ADAPTER_WALL_SECONDS=120`; `PROPERTY_CATALOG_INITIAL_BACKFILL_SOURCE_ADAPTER_WALL_SECONDS=540`; `PROPERTY_CATALOG_POSTGRES_STATEMENT_TIMEOUT_MS=8000`; `PROPERTY_CATALOG_PUBLISHER_WALL_MS=8500`                                  |
...
[`FI_INTERACTIVE_READ_MATRIX.md`](FI_INTERACTIVE_READ_MATRIX.md#current-source-production-select-matrix-supplementary-not-http-sign-off).
...
[exact live-qualifier boundary](FI_INTERACTIVE_READ_MATRIX.md#exact-live-qualifier-boundary).
