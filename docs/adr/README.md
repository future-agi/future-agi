...
| ADR-035 | fi-simulate human CLI — list/run/status subcommands | Accepted | #377 |
| [ADR-036](ADR-036-pact-formal-analysis-toolkit.md) | pact — Python + Go formal static analysis toolkit | Accepted | #379 |
